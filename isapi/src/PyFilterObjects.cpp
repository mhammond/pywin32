...
PyTypeObject PyFILTER_VERSIONType = {
    PYISAPI_OBJECT_HEAD "HTTP_FILTER_VERSION",
...
void PyFILTER_VERSION::deallocFunc(PyObject *ob) { delete (PyFILTER_VERSION *)ob; }
...
static struct PyMethodDef PyHFC_methods[] = {
    ...
    {"AddResponseHeaders", PyHFC::AddResponseHeaders,
     1},  // @pymeth AddResponseHeaders|Specifies a response header for IIS to send to the client.
...
PyTypeObject PyHFCType = {
    PYISAPI_OBJECT_HEAD "HTTP_FILTER_CONTEXT",
    sizeof(PyHFC),
    0,
...
void PyHFC::deallocFunc(PyObject *ob) { delete (PyHFC *)ob; }
...
PyTypeObject PyURL_MAPType = {
    PYISAPI_OBJECT_HEAD "HTTP_FILTER_URL_MAP",
    sizeof(PyURL_MAP),
    0,
...
PyURL_MAP::~PyURL_MAP() { Py_XDECREF(m_parent); }
...
void PyURL_MAP::deallocFunc(PyObject *ob) { delete (PyURL_MAP *)ob; }
...
PyTypeObject PyPREPROC_HEADERSType = {
    PYISAPI_OBJECT_HEAD "HTTP_FILTER_PREPROC_HEADERS",
...
PyPREPROC_HEADERS::~PyPREPROC_HEADERS() { Py_XDECREF(m_parent); }
...
void PyPREPROC_HEADERS::deallocFunc(PyObject *ob) { delete (PyPREPROC_HEADERS *)ob; }
...
PyTypeObject PyRAW_DATAType = {
    PYISAPI_OBJECT_HEAD "HTTP_FILTER_RAW_DATA",
    sizeof(PyRAW_DATA),
    0,
...
PyRAW_DATA::~PyRAW_DATA() { Py_XDECREF(m_parent); }
...
void PyRAW_DATA::deallocFunc(PyObject *ob) { delete (PyRAW_DATA *)ob; }
...
PyTypeObject PyAUTHENTType = {
    PYISAPI_OBJECT_HEAD "HTTP_FILTER_AUTHENT",
    sizeof(PyAUTHENT),
    0,
...
PyAUTHENT::~PyAUTHENT() { Py_XDECREF(m_parent); }
...
void PyAUTHENT::deallocFunc(PyObject *ob) { delete (PyAUTHENT *)ob; }
...
PyTypeObject PyFILTER_LOGType = {
    PYISAPI_OBJECT_HEAD "HTTP_FILTER_LOG",
    sizeof(PyFILTER_LOG),
    0,
...
PyFILTER_LOG::~PyFILTER_LOG() { Py_XDECREF(m_parent); }
...
void PyFILTER_LOG::deallocFunc(PyObject *ob) { delete (PyFILTER_LOG *)ob; }
