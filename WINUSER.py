...
WINVER = 0x0500
def IS_INTRESOURCE(_r): return ((((ULONG_PTR)(_r)) >> 16) == 0)

def MAKEINTRESOURCEA(i): return ((LPSTR)((ULONG_PTR)((WORD)(i))))

def MAKEINTRESOURCEW(i): return ((LPWSTR)((ULONG_PTR)((WORD)(i))))
...
def GET_APPCOMMAND_LPARAM(lParam): return ((short)(HIWORD(lParam) & ~FAPPCOMMAND_MASK))

def GET_DEVICE_LPARAM(lParam): return ((WORD)(HIWORD(lParam) & FAPPCOMMAND_MASK))

GET_MOUSEORKEY_LPARAM = GET_DEVICE_LPARAM
def GET_FLAGS_LPARAM(lParam): return (LOWORD(lParam))

def GET_KEYSTATE_LPARAM(lParam): return GET_FLAGS_LPARAM(lParam)
...
def POINTTOPOINTS(pt): return (MAKELONG((short)((pt).x), (short)((pt).y)))
...
WM_MOUSELAST = 0x0209
WHEEL_DELTA = 120
def GET_KEYSTATE_WPARAM(wParam): return (LOWORD(wParam))

def GET_XBUTTON_WPARAM(wParam): return (HIWORD(wParam))
...
INPUT_KEYBOARD = 1
INPUT_HARDWARE = 2
def TOUCH_COORD_TO_PIXEL(l): return ((l) / 100)
...
def GET_POINTERID_WPARAM(wParam): return (LOWORD(wParam))

def IS_POINTER_NEW_WPARAM(wParam): return IS_POINTER_FLAG_SET_WPARAM(wParam, POINTER_MESSAGE_FLAG_NEW)

def IS_POINTER_INRANGE_WPARAM(wParam): return IS_POINTER_FLAG_SET_WPARAM(wParam, POINTER_MESSAGE_FLAG_INRANGE)

def IS_POINTER_INCONTACT_WPARAM(wParam): return IS_POINTER_FLAG_SET_WPARAM(wParam, POINTER_MESSAGE_FLAG_INCONTACT)

def IS_POINTER_FIRSTBUTTON_WPARAM(wParam): return IS_POINTER_FLAG_SET_WPARAM(wParam, POINTER_MESSAGE_FLAG_FIRSTBUTTON)

def IS_POINTER_SECONDBUTTON_WPARAM(wParam): return IS_POINTER_FLAG_SET_WPARAM(wParam, POINTER_MESSAGE_FLAG_SECONDBUTTON)

def IS_POINTER_THIRDBUTTON_WPARAM(wParam): return IS_POINTER_FLAG_SET_WPARAM(wParam, POINTER_MESSAGE_FLAG_THIRDBUTTON)

def IS_POINTER_FOURTHBUTTON_WPARAM(wParam): return IS_POINTER_FLAG_SET_WPARAM(wParam, POINTER_MESSAGE_FLAG_FOURTHBUTTON)

def IS_POINTER_FIFTHBUTTON_WPARAM(wParam): return IS_POINTER_FLAG_SET_WPARAM(wParam, POINTER_MESSAGE_FLAG_FIFTHBUTTON)

def IS_POINTER_PRIMARY_WPARAM(wParam): return IS_POINTER_FLAG_SET_WPARAM(wParam, POINTER_MESSAGE_FLAG_PRIMARY)

def HAS_POINTER_CONFIDENCE_WPARAM(wParam): return IS_POINTER_FLAG_SET_WPARAM(wParam, POINTER_MESSAGE_FLAG_CONFIDENCE)

def IS_POINTER_CANCELED_WPARAM(wParam): return IS_POINTER_FLAG_SET_WPARAM(wParam, POINTER_MESSAGE_FLAG_CANCELED)
...
def _In_bypassable_reads_or_z_(size): return \
...
def SetSysModalWindow(hWnd): return (None)

def GetWindowTask(hWnd): return \
...
def GET_SC_WPARAM(wParam): return (wParam & 0xFFF0)
...
GA_ROOT = 2
GA_ROOTOWNER = 3
def GET_RAWINPUT_CODE_WPARAM(wParam): return ((wParam) & 0xff)
...
def RAWINPUT_ALIGN(x): return (((x) + sizeof(QWORD) - 1) & ~(sizeof(QWORD) - 1))

def RAWINPUT_ALIGN(x): return (((x) + sizeof - 1) & ~(sizeof - 1))
...
def RIDEV_EXMODE(mode): return ((mode) & RIDEV_EXMODEMASK)

GIDC_ARRIVAL = 1
GIDC_REMOVAL = 2
def GET_DEVICE_CHANGE_WPARAM(wParam): return (LOWORD(wParam))

def GET_DEVICE_CHANGE_LPARAM(lParam): return (LOWORD(lParam))
...
def GID_ROTATE_ANGLE_TO_ARGUMENT(_arg_): return ((USHORT)((((_arg_) + 2.0 * 3.14159265) / (4.0 * 3.14159265)) * 65535.0))

def GID_ROTATE_ANGLE_FROM_ARGUMENT(_arg_): return ((((double)(_arg_) / 65535.0) * 4.0 * 3.14159265) - 2.0 * 3.14159265)
