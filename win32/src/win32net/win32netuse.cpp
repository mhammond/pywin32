...
// @pymethod |win32net|NetUseAdd|Establishes connection between local or NULL device name and a shared resource through
// redirector
PyObject *PyNetUseAdd(PyObject *self, PyObject *args)
{
    WCHAR *szServer = NULL;
...
PyObject *PyNetUseDel(PyObject *self, PyObject *args)
{
    // @pyparm string/<o PyUnicode>|server||The name of the server, or None.
...
// @pymethod ([dict, ...], total, resumeHandle)|win32net|NetUseEnum|Retrieves information about transport protocols that
...
PyObject *PyNetUseEnum(PyObject *self, PyObject *args)
{
...
PyObject *PyNetUseGetInfo(PyObject *self, PyObject *args)
{
    ...
    // @pyparm int|level|0|The information level contained in the data. NOTE: levels 302 and 402 don't seem to work
