...
win32gui.StretchBlt(dcDC, 0, 0, desktopwidth, desktopheight,
                    dDC, 0, 0, desktopwidth, desktopheight, win32con.SRCCOPY)
...
win32gui.StretchBlt(pcDC, 0, 0, printerwidth, printerheight,
                    dcDC, 0, 0, desktopwidth, desktopheight, win32con.SRCCOPY)
