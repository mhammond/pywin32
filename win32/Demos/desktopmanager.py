...
def new_icon(hdesk, desktop_name):
    ...
    notify_info = (hwnd, id, flags, win32con.WM_USER+20, hicon,
...
def create_desktop(desktop_name, start_explorer=1):
    ...
    if start_explorer:
        ...
        prc_info = win32process.CreateProcess(
            None, "Explorer.exe", None, None, True, win32con.CREATE_NEW_CONSOLE, None, 'c:\\', s)
...
def icon_wndproc(hwnd, msg, wp, lp):
    ...
    if lp == win32con.WM_LBUTTONDOWN:
        ...
        curr_desktop = win32service.OpenInputDesktop(
            0, True, win32con.MAXIMUM_ALLOWED)
...
window_info = {}
origin_desktop = win32service.OpenInputDesktop(
    0, True, win32con.MAXIMUM_ALLOWED)
