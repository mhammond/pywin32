...
hklm = win32api.RegOpenKey(win32con.HKEY_LOCAL_MACHINE,
                           None, 0, win32con.KEY_ALL_ACCESS)
...
acl.AddAccessAllowedAce(win32con.ACL_REVISION, win32con.GENERIC_READ |
                        win32con.ACCESS_SYSTEM_SECURITY, my_sid)
