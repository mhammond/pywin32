...
def MakeDlgTemplate():
    ...
    dlg = [["OCX Demos", (0, 0, 350, 350), style, None,
            (8, "MS Sans Serif")], ]
...
#	dlg.append(["{8E27C92B-1264-101C-8A2F-040224009C02}", None, 131, (5, 40, 110, 48),win32con.WS_TABSTOP])
    ...
    dlg.append([128, "About", win32con.IDOK, (124, 5, 50, 14),
        ...
        def OnInitDialog(self):
            ...
            try:
                self.olectl.CreateControl(
                    "OCX", win32con.WS_TABSTOP | win32con.WS_VISIBLE, (7, 43, 500, 300), self._obj_, 131)
...
class OCXFrame(window.MDIChildWnd):
    ...
    def Create(self, controlClass, title, rect=None, parent=None):
        ...
        self.ocx.CreateControl("", win32con.WS_VISIBLE |
