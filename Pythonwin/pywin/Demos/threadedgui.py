...
class FontWindow(window.Wnd):
    ...
    def Create(self, title, style, rect, parent):
        ...
        self._obj_.CreateWindow(className, title, style,
                                rect, parent, win32ui.AFX_IDW_PANE_FIRST)
...
class FontFrame(window.MDIChildWnd):
    ...
    def Create(self, title, rect=None, parent=None):
        ...
        self.child.Create("FontDemo", win32con.WS_CHILD |
                          win32con.WS_VISIBLE, rect, self)
...
class TestThread(WinThread):
    ...
    def InitInstance(self):
        ...
        self.child.Create("FontDemo", win32con.WS_CHILD |
                          win32con.WS_VISIBLE, rect, self.parentWindow)
