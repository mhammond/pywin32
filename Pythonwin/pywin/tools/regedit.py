...
#		self.HookMessage(self.OnItemRightClick, win32con.WM_RBUTTONUP)
    ...
    def OnItemRightClick(self, notify_data, extra):
        ...
        menu.AppendMenu(win32con.MF_STRING |
                        win32con.MF_ENABLED, 1000, "Add Key")
        menu.AppendMenu(win32con.MF_STRING |
                        win32con.MF_ENABLED, 1001, "Add Value")
        menu.AppendMenu(win32con.MF_STRING |
                        win32con.MF_ENABLED, 1002, "Delete Key")
...
class RegistryValueView(docview.ListView):
    def OnInitialUpdate(self):
        ...
        win32api.SetWindowLong(
            hwnd, win32con.GWL_STYLE, (style & ~commctrl.LVS_TYPEMASK) | commctrl.LVS_REPORT)
...
#		frame.InitialUpdateFrame(doc, makeVisible)
    ...
    def OpenRegistryKey(self, root=None, subkey=None):
        ...
        try:
            ...
            while 1:
                try:
                    ...
                    break
                ret.append(HLIRegistryKey(
                    self.keyRoot, self.keyName + "\\" + key, key))
                keyNum = keyNum + 1
        finally:
            win32api.RegCloseKey(hkey)
