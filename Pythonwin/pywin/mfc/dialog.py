...
def dllFromDll(dllid):
    ...
    if dllid == None:
        ...
        try:
            ...
            raise TypeError(
                "DLL parameter must be None, a filename or a dll object")
        return dllid
...
class Dialog(window.Wnd):
    ...
    def OnDestroy(self, msg):
        # theoretically not needed if object destructs normally.
        self.dll = None
    # DDX support
    ...
    # self.UpdateData(0)
    def __setitem__(self, key, item): self._obj_.data[key] = item
...
class PrintDialog(Dialog):
    ...
    def OnInitDialog(self):
        # This also sets the hDC of the pInfo structure.
