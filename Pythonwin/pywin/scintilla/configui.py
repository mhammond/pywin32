...
class ScintillaFormatPropertyPage(dialog.PropertyPage):
    def __init__(self, scintillaClass=None, caption=0):
        ...
        dialog.PropertyPage.__init__(
            self, win32ui.IDD_PP_FORMAT, caption=caption)
    ...
    def OnInitDialog(self):
        try:
            ...
            self.HookCommand(self.OnButUseDefaultBackground,
                             win32ui.IDC_CHECK2)
    ...
    def OnButDefaultFixedFont(self, id, code):
        if code == win32con.BN_CLICKED:
            self._DoButDefaultFont(
                win32con.CF_FIXEDPITCHONLY, "baseFormatFixed")
            return 1
    ...
    def UpdateUIForStyle(self, style):
        ...
        self.GetDlgItem(win32ui.IDC_BUTTON3).EnableWindow(
            not style.IsBasedOnDefault())
    ...
    def ApplyUIFormatToStyle(self, style):
        ...
        style.format = (
            maskFlags, effect, style.format[2], style.format[3], color[1]) + style.format[5:]
