...
class GrepDocument(docview.RichEditDoc):
    ...
    def saveInitParams(self):
        ...
        paramstr = "\t%s\t\t%d\t%d" % (
            self.filpattern, self.casesensitive, self.recurse)
    ...
    def OnNewDocument(self):
        ...
        d = GrepDialog(self.dirpattern, self.filpattern, self.greppattern,
...
class GrepDialog(dialog.Dialog):
    def __init__(self, dp, fp, gp, cs, r, v):
        ...
        tmp.append([EDIT,   gp,                    101, (52,  7, 144,  11), CS |
        ...
        tmp.append([EDIT,   fp,                    103, (52, 33, 128,  11), CS |
                    win32con.WS_TABSTOP | win32con.ES_AUTOHSCROLL | win32con.WS_BORDER])
        tmp.append([BUTTON, '...',                 111, (182, 33,  16,
                                                         11), CS | win32con.BS_PUSHBUTTON | win32con.WS_TABSTOP])
        tmp.append([BUTTON, 'Case sensitive',       104, (7,  45,  72,  9), CS |
                    win32con.BS_AUTOCHECKBOX | win32con.BS_LEFTTEXT | win32con.WS_TABSTOP])
        tmp.append([BUTTON, 'Subdirectories',       105, (7,  56,  72,  9), CS |
                    win32con.BS_AUTOCHECKBOX | win32con.BS_LEFTTEXT | win32con.WS_TABSTOP])
        tmp.append([BUTTON, 'Verbose',              106, (7,  67,  72,  9), CS |
                    win32con.BS_AUTOCHECKBOX | win32con.BS_LEFTTEXT | win32con.WS_TABSTOP])
...
class GrepParamsDialog(dialog.Dialog):
    def __init__(self, items):
        ...
        style = win32con.DS_MODALFRAME | win32con.WS_POPUP | win32con.WS_VISIBLE | win32con.WS_CAPTION | win32con.WS_SYSMENU | win32con.DS_SETFONT
        CS = win32con.WS_CHILD | win32con.WS_VISIBLE
        tmp = [["Grep Parameters", (0, 0, 205, 100),
