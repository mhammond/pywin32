...
// PyCToolTipCtrl
//
static CToolTipCtrl *GetToolTipCtrl(PyObject *self) { return (CToolTipCtrl *)PyCWnd::GetPythonGenericWnd(self); }
PyCToolTipCtrl::PyCToolTipCtrl() {}
PyCToolTipCtrl::~PyCToolTipCtrl() {}

// @pymethod <o PyCToolTipCtrl>|win32ui|CreateToolTipCtrl|Creates a progress control object. <om PyToolTipCtrl.Create>
// creates the actual control.
PyObject *PyCToolTipCtrl_create(PyObject *self, PyObject *args)
{
    CHECK_NO_ARGS(args);
...
static PyObject *PyCToolTipCtrl_create_window(PyObject *self, PyObject *args)
{
    int style;
    PyObject *obParent;
...
static PyObject *PyCToolTipCtrl_update_tip_text(PyObject *self, PyObject *args)
{
    PyObject *obWnd;
    TCHAR *pszText;
    PyObject *obText;
...
static PyObject *PyCToolTipCtrl_add_tool(PyObject *self, PyObject *args)
{
...
static PyObject *PyCToolTipCtrl_set_max_tip_width(PyObject *self, PyObject *args)
{
    int width;
...
static struct PyMethodDef PyCToolTipCtrl_methods[] = {
    {"CreateWindow", PyCToolTipCtrl_create_window,
     1},  // @pymeth CreateWindow|Creates the window for a new progress bar object.
    {"UpdateTipText", PyCToolTipCtrl_update_tip_text,
     1},                                      // @pymeth UpdateTipText|Update the tool tip text for a control's tools
...
ui_type_CObject PyCToolTipCtrl::type("PyCToolTipCtrl", &ui_control_object::type, RUNTIME_CLASS(CToolTipCtrl),
                                     sizeof(PyCToolTipCtrl), PYOBJ_OFFSET(PyCToolTipCtrl), PyCToolTipCtrl_methods,
