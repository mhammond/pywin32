...
void ProcessShellMessage(HWND hWnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
    ...
    switch (lParam) {
        ...
        case WM_RBUTTONUP: {
            ...
            cmdId = TrackPopupMenu(hMenuTrackPopup, TPM_LEFTALIGN | TPM_TOPALIGN | TPM_RETURNCMD | TPM_RIGHTBUTTON,
...
DWORD DebuggerThreadFunc(LPDWORD lpdwWhatever)
{
    ...
    wc.cbWndExtra = 0;
    RegisterClass(&wc);
    hwndDebug = ::CreateWindowEx(0, className, _T("Python"), WS_OVERLAPPEDWINDOW, 14, 8, 70, 60, NULL, NULL,
