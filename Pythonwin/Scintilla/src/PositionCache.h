...
class LineLayout {
   ...
   public:
    ...
    void SetBracesHighlight(Range rangeLine, Position braces[], char bracesMatchStyle, int xHighlight);
...
class LineLayoutCache {
   ...
   public:
    ...
    LineLayout *Retrieve(int lineNumber, int lineCaret, int maxChars, int styleClock_, int linesOnScreen,
                         int linesInDoc);
...
class PositionCache {
   ...
   public:
    ...
    void MeasureWidths(Surface *surface, ViewStyle &vstyle, unsigned int styleNumber, const char *s, unsigned int len,
                       int *positions);
};

inline bool IsSpaceOrTab(int ch) { return ch == ' ' || ch == '\t'; }
