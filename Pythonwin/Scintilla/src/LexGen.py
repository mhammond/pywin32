    ...
    for line in input.splitlines(0):
        ...
        if isStartGenerated:
            ...
            if retainDefs:
                output.append(line)
    output = [line.rstrip(" \t")
              for line in output]  # trim trailing whitespace
...
def RegenerateAll():
    ...
    otherProps = ["abbrev.properties", "Embedded.properties",
                  "SciTEGlobal.properties", "SciTE.properties"]
    ...
    Regenerate(root + "scintilla/win32/scintilla_vc6.mak",
               "#", NATIVE, lexFiles)
    ...
    if os.path.exists(root + "scite"):
        Regenerate(root + "scite/win32/makefile",
                   "#", NATIVE, lexFiles, propFiles)
        Regenerate(root + "scite/win32/scite.mak",
                   "#", NATIVE, lexFiles, propFiles)
        Regenerate(root + "scite/src/SciTEProps.cxx",
                   "//", NATIVE, lexerProperties)
