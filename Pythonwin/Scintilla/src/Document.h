...
class Range {
   public:
    ...
    bool Contains(Range other) const { return Contains(other.start) && Contains(other.end); }
...
class RegexSearchBase {
   public:
    ...
    virtual long FindText(Document *doc, int minPos, int maxPos, const char *s, bool caseSensitive, bool word,
                          bool wordStart, int flags, int *length) = 0;
...
class Document {
   ...
   public:
    ...
    long FindText(int minPos, int maxPos, const char *s, bool caseSensitive, bool word, bool wordStart, bool regExp,
...
class DocModification {
   public:
    ...
    DocModification(int modificationType_, int position_ = 0, int length_ = 0, int linesAdded_ = 0,
                    const char *text_ = 0, int line_ = 0)
