        ...
        try:
            ...
            if ext.name in ("pywintypes", "pythoncom"):
                ...
                if sys.version_info >= (3, 10):
                    ##name1 = ext.name + '.cp%s%s-win_%s' % (sys.version_info[0], sys.version_info[1], platform.machine().lower()) + extra
                    name1 = ext.name + distutils.sysconfig.get_config_var('EXT_SUFFIX').rsplit('.', 1)[0] + extra
                    # -> e.g.: 'win32ui.cp310-win_amd64.lib'
