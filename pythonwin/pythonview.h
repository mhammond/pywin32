...
class CPythonFormView : public CPythonViewFramework<CFormView> {
   public:
    CPythonFormView(UINT id) : CPythonViewFramework<CFormView>(id) { ; }
    CPythonFormView(LPCTSTR id) : CPythonViewFramework<CFormView>(id) { ; }
...
class CPythonCtrlView : public CPythonViewFramework<CCtrlView> {
   ...
   public:
    CPythonCtrlView(LPCTSTR lpszClass, DWORD dwStyle) : CPythonViewFramework<CCtrlView>(lpszClass, dwStyle) { ; }
};
