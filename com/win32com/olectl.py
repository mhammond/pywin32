...
CONNECT_E_FIRST = MAKE_SCODE(winerror.SEVERITY_ERROR,
                             winerror.FACILITY_ITF,
                             0x0200)
CONNECT_E_LAST = MAKE_SCODE(winerror.SEVERITY_ERROR,
                            winerror.FACILITY_ITF,
                            0x020F)
CONNECT_S_FIRST = MAKE_SCODE(winerror.SEVERITY_SUCCESS,
                             winerror.FACILITY_ITF,
                             0x0200)
CONNECT_S_LAST = MAKE_SCODE(winerror.SEVERITY_SUCCESS,
                            winerror.FACILITY_ITF,
                            0x020F)
