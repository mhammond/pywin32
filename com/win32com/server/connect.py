...
IConnectionPointContainer_methods = ["EnumConnectionPoints",
                                     "FindConnectionPoint"]
IConnectionPoint_methods = ["EnumConnections",
                            "Unadvise",
                            "Advise",
...
class ConnectableServer:
    ...
    def Advise(self, pUnk):
        ...
        try:
            interface = pUnk.QueryInterface(self._connect_interfaces_[0],
    ...
    def FindConnectionPoint(self, iid):
        # Find a connection we support.
        # Only support the single event interface.
