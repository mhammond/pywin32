...
class TestEnum(win32com.test.util.TestCase):
    def testit(self):
        ...
        pssum.WriteMultiple((storagecon.PIDSI_AUTHOR,
        ...
        for psstat in pssread:
            ...
            ps = None
            # # FMTID_UserDefinedProperties can't exist without
            # # FMTID_DocSummaryInformation, and isn't returned independently
            # # from Enum also can't be open at same time
