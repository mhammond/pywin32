...
PyIEnumConnections::PyIEnumConnections(IUnknown *pdisp) : PyIUnknown(pdisp) { ob_type = &type; }
...
// @pymethod <o PyIEnumConnections>|PyIEnumConnections|Clone|Creates another enumerator that contains the same
...
static struct PyMethodDef PyIEnumConnections_methods[] = {
    ...
    {"Clone", PyIEnumConnections::Clone,
...
PyComEnumTypeObject PyIEnumConnections::type("PyIEnumConnections",
                                             ...
                                             sizeof(PyIEnumConnections), PyIEnumConnections_methods,
