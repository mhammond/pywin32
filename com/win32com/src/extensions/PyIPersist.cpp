...
PyIPersist::PyIPersist(IUnknown *pdisp) : PyIUnknown(pdisp) { ob_type = &type; }

PyIPersist::~PyIPersist() {}

/* static */ IPersist *PyIPersist::GetI(PyObject *self) { return (IPersist *)PyIUnknown::GetI(self); }
...
static struct PyMethodDef PyIPersist_methods[] = {
    {"GetClassID", PyIPersist::GetClassID,
     1},  // @pymeth GetClassID|Returns the class identifier (CLSID) for the component object.
    {NULL}};

PyComTypeObject PyIPersist::type("PyIPersist",
                                 &PyIUnknown::type,  // @base PyIPersist|PyIUnknown
                                 sizeof(PyIPersist), PyIPersist_methods, GET_PYCOM_CTOR(PyIPersist));
