...
# ADD LINK32 ole32.lib oleaut32.lib uuid.lib /nologo /base:"0x1e2b0000" /subsystem:windows /dll /debug /machine:I386 /nodefaultlib:"ciuuid.lib" /out:"Build\axscript.pyd" /libpath:"build" /libpath:"..\win32\build"
...
# ADD LINK32 ole32.lib oleaut32.lib uuid.lib /nologo /base:"0x1e2b0000" /subsystem:windows /dll /debug /machine:I386 /nodefaultlib:"ciuuid.lib" /out:"Build\axscript_d.pyd" /libpath:"build" /libpath:"..\win32\build"
