...
PyIDirectSoundNotify::PyIDirectSoundNotify(IUnknown *pdisp) : PyIUnknown(pdisp), m_DS(NULL) { ob_type = &type; }
...
argerror:
    ...
    PyErr_SetString(PyExc_TypeError,
                    "Argument must be a tuple (or a list of tuples) with two items: position and win32 Event handle");
    return NULL;
}

// @object PyIDirectSoundNotify|Description of the interface
static struct PyMethodDef PyIDirectSoundNotify_methods[] = {
    {"SetNotificationPositions", PyIDirectSoundNotify::SetNotificationPositions,
     1},  // @pymeth Initialize|Description of SetNotificationPositions.
    {NULL}};

PyComTypeObject PyIDirectSoundNotify::type("PyIDirectSoundNotify", &PyIUnknown::type, sizeof(PyIDirectSoundNotify),
                                           PyIDirectSoundNotify_methods, GET_PYCOM_CTOR(PyIDirectSoundNotify));
