...
# if not set, display names for shell name space items that are not in the file system will fail.
SHGDN_INCLUDE_NONFILESYS = 8192
# for displaying in the address (drives dropdown) bar
...
IContextMenu_Methods = ["QueryContextMenu",
                        "InvokeCommand", "GetCommandString"]
