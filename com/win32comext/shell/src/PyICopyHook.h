...
class PyGCopyHookA : public PyGatewayBase, public ICopyHookA {
   protected:
    ...
    (HWND hwnd, UINT wFunc, UINT wFlags, LPCSTR srcFile, DWORD srcAttribs, LPCSTR destFile, DWORD destAttribs);
};
...
class PyGCopyHookW : public PyGatewayBase, public ICopyHookW {
   protected:
    ...
    // ICopyHook
    STDMETHOD_(UINT, CopyCallback)
    (HWND hwnd, UINT wFunc, UINT wFlags, LPCWSTR srcFile, DWORD srcAttribs, LPCWSTR destFile, DWORD destAttribs);
};
