...
PyIEnumResources::PyIEnumResources(IUnknown *pdisp) : PyIUnknown(pdisp) { ob_type = &type; }

PyIEnumResources::~PyIEnumResources() {}

/* static */ IEnumResources *PyIEnumResources::GetI(PyObject *self) { return (IEnumResources *)PyIUnknown::GetI(self); }
...
// @pymethod <o PyIEnumResources>|PyIEnumResources|Clone|Creates another enumerator that contains the same enumeration
...
static struct PyMethodDef PyIEnumResources_methods[] = {
    ...
    {"Clone", PyIEnumResources::Clone,
     1},  // @pymeth Clone|Creates another enumerator that contains the same enumeration state as the current one.
    {NULL}};

PyComEnumTypeObject PyIEnumResources::type("PyIEnumResources", &PyIUnknown::type, sizeof(PyIEnumResources),
                                           PyIEnumResources_methods, GET_PYCOM_CTOR(PyIEnumResources));
