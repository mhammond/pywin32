...
class PyGDropTargetHelper : public PyGatewayBase, public IDropTargetHelper {
   protected:
    ...
    // IDropTargetHelper
    STDMETHOD(DragEnter)(HWND hwnd, IDataObject *pDataObj, POINT *pt, DWORD dwEffect);

    STDMETHOD(DragOver)(POINT *pt, DWORD dwEffect);

    STDMETHOD(DragLeave)(void);

    STDMETHOD(Drop)(IDataObject *pDataObj, POINT *pt, DWORD dwEffect);
