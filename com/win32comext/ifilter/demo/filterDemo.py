...
class FileParser:
    ...
    def Parse(self, fileName, maxErrors=10):
        ...
        try:
            ...
            try:
                flags = self.f.Init(
                    IFILTER_INIT_APPLY_INDEX_ATTRIBUTES | IFILTER_INIT_APPLY_OTHER_ATTRIBUTES)
                ...
                while True:
                    try:
                        ...
                        self._trace("Chunk details:", idChunk, breakType, flags,
                                    locale, attr, idChunkSource, startSource, lenSource)
                    ...
                    if flags == CHUNK_TEXT:
                        ...
                        self._trace(
                            "Unknown flag returned by GetChunk:", flags)
            finally:
                self.Close()
    ...
    def _get_properties(self, properties):
        ...
        props = (PIDSI_TITLE, PIDSI_SUBJECT, PIDSI_AUTHOR,
                 PIDSI_KEYWORDS, PIDSI_COMMENTS)
