...
static PyObject *PyEditSecurity(PyObject *self, PyObject *args, PyObject *kwargs)
{
    ...
    if (!PyArg_ParseTupleAndKeywords(
            args, kwargs, "OO:EditSecurity", keywords,
            &obhwnd,  // @pyparm <o PyHANDLE>|hwndOwner||Handle to window that owns dialog, can be None
            &obisi))  // @pyparm <o PyGSecurityInformation>|psi||Class instance that implements the ISecurityInformation
                      // interface
        return NULL;
...
static const PyCom_InterfaceSupportInfo interface_info[] = {PYCOM_INTERFACE_SERVER_ONLY(SecurityInformation)};
...
static struct PyMethodDef authorization_methods[] = {
    {"EditSecurity", (PyCFunction)PyEditSecurity, METH_VARARGS | METH_KEYWORDS,
     "Creates a security descriptor editor dialog"},  // @pymeth EditSecurity|Creates a security descriptor editor
                                                      // dialog
    {NULL}};
