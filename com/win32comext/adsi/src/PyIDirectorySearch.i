...
PyIDirectorySearch::PyIDirectorySearch(IUnknown *pDisp) : PyIUnknown(pDisp) { ob_type = &type; }

PyIDirectorySearch::~PyIDirectorySearch() {}

IDirectorySearch *PyIDirectorySearch::GetI(PyObject *self) { return (IDirectorySearch *)PyIUnknown::GetI(self); }
...
PyObject *PyIDirectorySearch::SetSearchPreference(PyObject *self, PyObject *args)
{
    ...
    Py_BEGIN_ALLOW_THREADS _result = (HRESULT)_swig_self->SetSearchPreference(p, numPrefs);
    Py_END_ALLOW_THREADS PyObject *ret = NULL;
    for (i = 0; i < numPrefs; i++) PyList_SET_ITEM(retStatus, i, PyLong_FromLong(p[i].dwStatus));
    PyADSIObject_FreeADS_SEARCHPREF_INFOs(p, numPrefs);
...
PyObject *PyIDirectorySearch::ExecuteSearch(PyObject *self, PyObject *args)
{
    ...
    Py_BEGIN_ALLOW_THREADS _result = (HRESULT)_swig_self->ExecuteSearch(szFilter, names, cnames, &handle);
    Py_END_ALLOW_THREADS PyObject *ret = NULL;
    if (FAILED(_result))
...
PyObject *PyIDirectorySearch::GetNextRow(PyObject *self, PyObject *args)
{
    ...
    Py_BEGIN_ALLOW_THREADS _result = (HRESULT_KEEP_INFO)_swig_self->GetNextRow(_arg0);
...
PyObject *PyIDirectorySearch::GetFirstRow(PyObject *self, PyObject *args)
{
    ...
    Py_BEGIN_ALLOW_THREADS _result = (HRESULT_KEEP_INFO)_swig_self->GetFirstRow(_arg0);
    Py_END_ALLOW_THREADS
...
PyObject *PyIDirectorySearch::GetPreviousRow(PyObject *self, PyObject *args)
{
    ...
    Py_BEGIN_ALLOW_THREADS _result = (HRESULT_KEEP_INFO)_swig_self->GetPreviousRow(_arg0);
    Py_END_ALLOW_THREADS
...
PyObject *PyIDirectorySearch::CloseSearchHandle(PyObject *self, PyObject *args)
{
    ...
    Py_BEGIN_ALLOW_THREADS _result = (HRESULT)_swig_self->CloseSearchHandle(_arg0);
    Py_END_ALLOW_THREADS
...
PyObject *PyIDirectorySearch::AbandonSearch(PyObject *self, PyObject *args)
{
    ...
    Py_BEGIN_ALLOW_THREADS _result = (HRESULT)_swig_self->AbandonSearch(_arg0);
    Py_END_ALLOW_THREADS
...
PyObject *PyIDirectorySearch::GetColumn(PyObject *self, PyObject *args)
{
    ...
    Py_BEGIN_ALLOW_THREADS _result = (HRESULT)_swig_self->GetColumn((ADS_SEARCH_HANDLE)handle, szName, &col);
    Py_END_ALLOW_THREADS if (FAILED(_result)) PyCom_BuildPyException(_result, _swig_self, IID_IDirectoryObject);
    else
    {
...
PyObject *PyIDirectorySearch::GetNextColumnName(PyObject *self, PyObject *args)
{
    ...
    PyObject *ret = NULL;
    WCHAR *szName = NULL;
    Py_BEGIN_ALLOW_THREADS _result = (HRESULT)_swig_self->GetNextColumnName((ADS_SEARCH_HANDLE)handle, &szName);
    Py_END_ALLOW_THREADS if (FAILED(_result)) PyCom_BuildPyException(_result, _swig_self, IID_IDirectoryObject);
