...
PyIDirectoryObject::PyIDirectoryObject(IUnknown *pDisp) : PyIUnknown(pDisp) { ob_type = &type; }

PyIDirectoryObject::~PyIDirectoryObject() {}

IDirectoryObject *PyIDirectoryObject::GetI(PyObject *self) { return (IDirectoryObject *)PyIUnknown::GetI(self); }

%}

// @pyswig <o PyADS_OBJECT_INFO>|GetObjectInformation|Retrieves an <o PyADS_OBJECT_INFO> object that contains
// information about the identity and location of a directory service object.
HRESULT GetObjectInformation(ADS_OBJECT_INFO **OUTPUT);

%{

// @pyswig (<o PyADS_ATTR_INFO>, ...)|GetObjectAttributes|Gets one or more specified attributes of the directory service
// object, as defined in the <o PyADS_ATTR_INFO> structure.
PyObject *PyIDirectoryObject::GetObjectAttributes(PyObject *self, PyObject *args)
{
    ...
    Py_BEGIN_ALLOW_THREADS _result = (HRESULT)_swig_self->GetObjectAttributes(names, cnames, &attrs, &cattrs);
...
%{
// @pyswig int|SetObjectAttributes|Sets one or more specified attributes of the directory service object, as defined in
// the <o PyADS_ATTR_INFO> structure.
PyObject *PyIDirectoryObject::SetObjectAttributes(PyObject *self, PyObject *args)
{
    ...
    Py_BEGIN_ALLOW_THREADS _result = (HRESULT)_swig_self->SetObjectAttributes(attr, cattr, &numset);
    Py_END_ALLOW_THREADS PyObject *ret = NULL;
    if (FAILED(_result)) {
        PyCom_BuildPyException(_result, _swig_self, IID_IDirectoryObject);
    }
...
PyObject *PyIDirectoryObject::CreateDSObject(PyObject *self, PyObject *args)
{
    ...
    Py_BEGIN_ALLOW_THREADS _result = (HRESULT)_swig_self->CreateDSObject(szName, attr, cattr, &pRet);
    Py_END_ALLOW_THREADS PyObject *ret = NULL;
    if (FAILED(_result)) {
        PyCom_BuildPyException(_result, _swig_self, IID_IDirectoryObject);
    }
