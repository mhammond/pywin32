...
PKEY_Audio_IsVariableBitRate = (
    IID('{E6822FEE-8C17-4D62-823C-8E9CFCBD1D5C}'), 100)
...
PKEY_Calendar_IsRecurring = (
    IID('{315B9C8D-80A9-4EF9-AE16-8E746DA51D70}'), 100)
PKEY_Calendar_Location = (IID('{F6272D18-CECC-40B1-B26A-3911717AA7BD}'), 100)
PKEY_Calendar_OptionalAttendeeAddresses = (
    IID('{D55BAE5A-3892-417A-A649-C6AC5AAAEAB3}'), 100)
PKEY_Calendar_OptionalAttendeeNames = (
    IID('{09429607-582D-437F-84C3-DE93A2B24C3C}'), 100)
PKEY_Calendar_OrganizerAddress = (
    IID('{744C8242-4DF5-456C-AB9E-014EFB9021E3}'), 100)
PKEY_Calendar_OrganizerName = (
    IID('{AAA660F9-9865-458E-B484-01BC7FE3973E}'), 100)
PKEY_Calendar_ReminderTime = (
    IID('{72FC5BA4-24F9-4011-9F3F-ADD27AFAD818}'), 100)
PKEY_Calendar_RequiredAttendeeAddresses = (
    IID('{0BA7D6C3-568D-4159-AB91-781A91FB71E5}'), 100)
PKEY_Calendar_RequiredAttendeeNames = (
    IID('{B33AF30B-F552-4584-936C-CB93E5CDA29F}'), 100)
...
PKEY_Calendar_ShowTimeAsText = (
    IID('{53DA57CF-62C0-45C4-81DE-7610BCEFD7F5}'), 100)
PKEY_Communication_AccountName = (
    IID('{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}'), 9)
PKEY_Communication_Suffix = (
    IID('{807B653A-9E91-43EF-8F97-11CE04EE20C5}'), 100)
PKEY_Communication_TaskStatus = (
    IID('{BE1A72C6-9A1D-46B7-AFE7-AFAF8CEF4999}'), 100)
PKEY_Communication_TaskStatusText = (
    IID('{A6744477-C237-475B-A075-54F34498292A}'), 100)
PKEY_Computer_DecoratedFreeSpace = (
    IID('{9B174B35-40FF-11D2-A27E-00C04FC30871}'), 7)
PKEY_Contact_Anniversary = (IID('{9AD5BADB-CEA7-4470-A03D-B84E51B9949E}'), 100)
PKEY_Contact_AssistantName = (
    IID('{CD102C9C-5540-4A88-A6F6-64E4981C8CD1}'), 100)
PKEY_Contact_AssistantTelephone = (
    IID('{9A93244D-A7AD-4FF8-9B99-45EE4CC09AF6}'), 100)
PKEY_Contact_Birthday = (IID('{176DC63C-2688-4E89-8143-A347800F25E9}'), 47)
PKEY_Contact_BusinessAddress = (
    IID('{730FB6DD-CF7C-426B-A03F-BD166CC9EE24}'), 100)
PKEY_Contact_BusinessAddressCity = (
    IID('{402B5934-EC5A-48C3-93E6-85E86A2D934E}'), 100)
PKEY_Contact_BusinessAddressCountry = (
    IID('{B0B87314-FCF6-4FEB-8DFF-A50DA6AF561C}'), 100)
PKEY_Contact_BusinessAddressPostalCode = (
    IID('{E1D4A09E-D758-4CD1-B6EC-34A8B5A73F80}'), 100)
PKEY_Contact_BusinessAddressPostOfficeBox = (
    IID('{BC4E71CE-17F9-48D5-BEE9-021DF0EA5409}'), 100)
PKEY_Contact_BusinessAddressState = (
    IID('{446F787F-10C4-41CB-A6C4-4D0343551597}'), 100)
PKEY_Contact_BusinessAddressStreet = (
    IID('{DDD1460F-C0BF-4553-8CE4-10433C908FB0}'), 100)
PKEY_Contact_BusinessFaxNumber = (
    IID('{91EFF6F3-2E27-42CA-933E-7C999FBE310B}'), 100)
PKEY_Contact_BusinessHomePage = (
    IID('{56310920-2491-4919-99CE-EADB06FAFDB2}'), 100)
PKEY_Contact_BusinessTelephone = (
    IID('{6A15E5A0-0A1E-4CD7-BB8C-D2F1B0C929BC}'), 100)
PKEY_Contact_CallbackTelephone = (
    IID('{BF53D1C3-49E0-4F7F-8567-5A821D8AC542}'), 100)
PKEY_Contact_CarTelephone = (
    IID('{8FDC6DEA-B929-412B-BA90-397A257465FE}'), 100)
PKEY_Contact_Children = (IID('{D4729704-8EF1-43EF-9024-2BD381187FD5}'), 100)
PKEY_Contact_CompanyMainTelephone = (
    IID('{8589E481-6040-473D-B171-7FA89C2708ED}'), 100)
PKEY_Contact_Department = (IID('{FC9F7306-FF8F-4D49-9FB6-3FFE5C0951EC}'), 100)
PKEY_Contact_EmailAddress = (
    IID('{F8FA7FA3-D12B-4785-8A4E-691A94F7A3E7}'), 100)
PKEY_Contact_EmailAddress2 = (
    IID('{38965063-EDC8-4268-8491-B7723172CF29}'), 100)
PKEY_Contact_EmailAddress3 = (
    IID('{644D37B4-E1B3-4BAD-B099-7E7C04966ACA}'), 100)
PKEY_Contact_EmailAddresses = (
    IID('{84D8F337-981D-44B3-9615-C7596DBA17E3}'), 100)
...
PKEY_Contact_HomeAddressCity = (
    IID('{176DC63C-2688-4E89-8143-A347800F25E9}'), 65)
PKEY_Contact_HomeAddressCountry = (
    IID('{08A65AA1-F4C9-43DD-9DDF-A33D8E7EAD85}'), 100)
PKEY_Contact_HomeAddressPostalCode = (
    IID('{8AFCC170-8A46-4B53-9EEE-90BAE7151E62}'), 100)
PKEY_Contact_HomeAddressPostOfficeBox = (
    IID('{7B9F6399-0A3F-4B12-89BD-4ADC51C918AF}'), 100)
PKEY_Contact_HomeAddressState = (
    IID('{C89A23D0-7D6D-4EB8-87D4-776A82D493E5}'), 100)
PKEY_Contact_HomeAddressStreet = (
    IID('{0ADEF160-DB3F-4308-9A21-06237B16FA2A}'), 100)
PKEY_Contact_HomeFaxNumber = (
    IID('{660E04D6-81AB-4977-A09F-82313113AB26}'), 100)
PKEY_Contact_HomeTelephone = (
    IID('{176DC63C-2688-4E89-8143-A347800F25E9}'), 20)
...
PKEY_Contact_JA_CompanyNamePhonetic = (
    IID('{897B3694-FE9E-43E6-8066-260F590C0100}'), 2)
PKEY_Contact_JA_FirstNamePhonetic = (
    IID('{897B3694-FE9E-43E6-8066-260F590C0100}'), 3)
PKEY_Contact_JA_LastNamePhonetic = (
    IID('{897B3694-FE9E-43E6-8066-260F590C0100}'), 4)
...
PKEY_Contact_MailingAddress = (
    IID('{C0AC206A-827E-4650-95AE-77E2BB74FCC9}'), 100)
PKEY_Contact_MiddleName = (IID('{176DC63C-2688-4E89-8143-A347800F25E9}'), 71)
PKEY_Contact_MobileTelephone = (
    IID('{176DC63C-2688-4E89-8143-A347800F25E9}'), 35)
PKEY_Contact_NickName = (IID('{176DC63C-2688-4E89-8143-A347800F25E9}'), 74)
PKEY_Contact_OfficeLocation = (
    IID('{176DC63C-2688-4E89-8143-A347800F25E9}'), 7)
PKEY_Contact_OtherAddress = (
    IID('{508161FA-313B-43D5-83A1-C1ACCF68622C}'), 100)
PKEY_Contact_OtherAddressCity = (
    IID('{6E682923-7F7B-4F0C-A337-CFCA296687BF}'), 100)
PKEY_Contact_OtherAddressCountry = (
    IID('{8F167568-0AAE-4322-8ED9-6055B7B0E398}'), 100)
PKEY_Contact_OtherAddressPostalCode = (
    IID('{95C656C1-2ABF-4148-9ED3-9EC602E3B7CD}'), 100)
PKEY_Contact_OtherAddressPostOfficeBox = (
    IID('{8B26EA41-058F-43F6-AECC-4035681CE977}'), 100)
PKEY_Contact_OtherAddressState = (
    IID('{71B377D6-E570-425F-A170-809FAE73E54E}'), 100)
PKEY_Contact_OtherAddressStreet = (
    IID('{FF962609-B7D6-4999-862D-95180D529AEA}'), 100)
PKEY_Contact_PagerTelephone = (
    IID('{D6304E01-F8F5-4F45-8B15-D024A6296789}'), 100)
PKEY_Contact_PersonalTitle = (
    IID('{176DC63C-2688-4E89-8143-A347800F25E9}'), 69)
PKEY_Contact_PrimaryAddressCity = (
    IID('{C8EA94F0-A9E3-4969-A94B-9C62A95324E0}'), 100)
PKEY_Contact_PrimaryAddressCountry = (
    IID('{E53D799D-0F3F-466E-B2FF-74634A3CB7A4}'), 100)
PKEY_Contact_PrimaryAddressPostalCode = (
    IID('{18BBD425-ECFD-46EF-B612-7B4A6034EDA0}'), 100)
PKEY_Contact_PrimaryAddressPostOfficeBox = (
    IID('{DE5EF3C7-46E1-484E-9999-62C5308394C1}'), 100)
PKEY_Contact_PrimaryAddressState = (
    IID('{F1176DFE-7138-4640-8B4C-AE375DC70A6D}'), 100)
PKEY_Contact_PrimaryAddressStreet = (
    IID('{63C25B20-96BE-488F-8788-C09C407AD812}'), 100)
PKEY_Contact_PrimaryEmailAddress = (
    IID('{176DC63C-2688-4E89-8143-A347800F25E9}'), 48)
PKEY_Contact_PrimaryTelephone = (
    IID('{176DC63C-2688-4E89-8143-A347800F25E9}'), 25)
...
PKEY_Contact_TTYTDDTelephone = (
    IID('{AAF16BAC-2B55-45E6-9F6D-415EB94910DF}'), 100)
...
PKEY_ItemFolderPathDisplayNarrow = (
    IID('{DABD30ED-0043-4789-A7F8-D013A4736622}'), 100)
...
PKEY_ParentalRatingReason = (
    IID('{10984E0A-F9F2-4321-B7EF-BAF195AF4319}'), 100)
PKEY_ParentalRatingsOrganization = (
    IID('{A7FE0840-1344-46F0-8D37-52ED712A4BF9}'), 100)
...
PKEY_Document_HiddenSlideCount = (
    IID('{D5CDD502-2E9C-101B-9397-08002B2CF9AE}'), 9)
...
PKEY_Document_MultimediaClipCount = (
    IID('{D5CDD502-2E9C-101B-9397-08002B2CF9AE}'), 10)
...
PKEY_Document_ParagraphCount = (
    IID('{D5CDD502-2E9C-101B-9397-08002B2CF9AE}'), 6)
PKEY_Document_PresentationFormat = (
    IID('{D5CDD502-2E9C-101B-9397-08002B2CF9AE}'), 3)
PKEY_Document_RevisionNumber = (
    IID('{F29F85E0-4FF9-1068-AB91-08002B27B3D9}'), 9)
...
PKEY_Document_TotalEditingTime = (
    IID('{F29F85E0-4FF9-1068-AB91-08002B27B3D9}'), 10)
...
PKEY_GPS_AltitudeDenominator = (
    IID('{78342DCB-E358-4145-AE9A-6BFE4E0F9F51}'), 100)
PKEY_GPS_AltitudeNumerator = (
    IID('{2DAD1EB7-816D-40D3-9EC3-C9773BE2AADE}'), 100)
...
PKEY_GPS_DestBearingDenominator = (
    IID('{7ABCF4F8-7C3F-4988-AC91-8D2C2E97ECA5}'), 100)
PKEY_GPS_DestBearingNumerator = (
    IID('{BA3B1DA9-86EE-4B5D-A2A4-A271A429F0CF}'), 100)
...
PKEY_GPS_DestDistanceDenominator = (
    IID('{9BC2C99B-AC71-4127-9D1C-2596D0D7DCB7}'), 100)
PKEY_GPS_DestDistanceNumerator = (
    IID('{2BDA47DA-08C6-4FE1-80BC-A72FC517C5D0}'), 100)
...
PKEY_GPS_DestLatitudeDenominator = (
    IID('{3A372292-7FCA-49A7-99D5-E47BB2D4E7AB}'), 100)
PKEY_GPS_DestLatitudeNumerator = (
    IID('{ECF4B6F6-D5A6-433C-BB92-4076650FC890}'), 100)
...
PKEY_GPS_DestLongitudeDenominator = (
    IID('{425D69E5-48AD-4900-8D80-6EB6B8D0AC86}'), 100)
PKEY_GPS_DestLongitudeNumerator = (
    IID('{A3250282-FB6D-48D5-9A89-DBCACE75CCCF}'), 100)
PKEY_GPS_DestLongitudeRef = (
    IID('{182C1EA6-7C1C-4083-AB4B-AC6C9F4ED128}'), 100)
...
PKEY_GPS_ImgDirectionDenominator = (
    IID('{10B24595-41A2-4E20-93C2-5761C1395F32}'), 100)
PKEY_GPS_ImgDirectionNumerator = (
    IID('{DC5877C7-225F-45F7-BAC7-E81334B6130A}'), 100)
...
PKEY_GPS_LatitudeDenominator = (
    IID('{16E634EE-2BFF-497B-BD8A-4341AD39EEB9}'), 100)
PKEY_GPS_LatitudeNumerator = (
    IID('{7DDAAAD1-CCC8-41AE-B750-B2CB8031AEA2}'), 100)
...
PKEY_GPS_LongitudeDenominator = (
    IID('{BE6E176C-4534-4D2C-ACE5-31DEDAC1606B}'), 100)
PKEY_GPS_LongitudeNumerator = (
    IID('{02B0F689-A914-4E45-821D-1DDA452ED2C4}'), 100)
...
PKEY_GPS_ProcessingMethod = (
    IID('{59D49E61-840F-4AA9-A939-E2099B7F6399}'), 100)
...
PKEY_GPS_SpeedDenominator = (
    IID('{7D122D5A-AE5E-4335-8841-D71E7CE72F53}'), 100)
...
PKEY_GPS_TrackDenominator = (
    IID('{C8D1920C-01F6-40C0-AC86-2F3A4AD00770}'), 100)
...
PKEY_Image_ResolutionUnit = (
    IID('{19B51FA6-1F92-4A5C-AB48-7DF0ABD67444}'), 100)
PKEY_Image_VerticalResolution = (
    IID('{6444048F-4C8B-11D1-8B70-080036B11A03}'), 6)
...
PKEY_Link_TargetParsingPath = (
    IID('{B9B4B3FC-2B51-4A42-B5D8-324146AFCF25}'), 2)
...
PKEY_Media_EncodingSettings = (
    IID('{64440492-4C8B-11D1-8B70-080036B11A03}'), 37)
...
PKEY_Media_MetadataContentProvider = (
    IID('{64440492-4C8B-11D1-8B70-080036B11A03}'), 17)
...
PKEY_Message_AttachmentContents = (
    IID('{3143BF7C-80A8-4854-8880-E2E40189BDD0}'), 100)
PKEY_Message_AttachmentNames = (
    IID('{E3E0584C-B788-4A5A-BB20-7F5A44C9ACDD}'), 21)
...
PKEY_Message_ConversationID = (
    IID('{DC8F80BD-AF1E-4289-85B6-3DFC1B493992}'), 100)
PKEY_Message_ConversationIndex = (
    IID('{DC8F80BD-AF1E-4289-85B6-3DFC1B493992}'), 101)
...
PKEY_Message_HasAttachments = (
    IID('{9C1FCF74-2D97-41BA-B4AE-CB2E3661A6E4}'), 8)
PKEY_Message_IsFwdOrReply = (
    IID('{9A9BC088-4F6D-469E-9919-E705412040F9}'), 100)
PKEY_Message_MessageClass = (
    IID('{CD9ED458-08CE-418F-A70E-F912C7BB9C5C}'), 103)
PKEY_Message_SenderAddress = (
    IID('{0BE1C8E7-1981-4676-AE14-FDD78F05A6E7}'), 100)
...
PKEY_Music_ContentGroupDescription = (
    IID('{56A3372E-CE9C-11D2-9F0E-006097C686F6}'), 33)
...
PKEY_Music_SynchronizedLyrics = (
    IID('{6B223B6A-162E-4AA9-B39F-05D678FC6D77}'), 100)
...
PKEY_Photo_DigitalZoomDenominator = (
    IID('{745BAF0E-E5C1-4CFB-8A1B-D031A0A52393}'), 100)
PKEY_Photo_DigitalZoomNumerator = (
    IID('{16CBB924-6500-473B-A5BE-F1599BCBE413}'), 100)
...
PKEY_Photo_ExposureBias = (
    IID('{14B81DA1-0135-4D31-96D9-6CBFC9671A99}'), 37380)
PKEY_Photo_ExposureBiasDenominator = (
    IID('{AB205E50-04B7-461C-A18C-2F233836E627}'), 100)
PKEY_Photo_ExposureBiasNumerator = (
    IID('{738BF284-1D87-420B-92CF-5834BF6EF9ED}'), 100)
PKEY_Photo_ExposureIndex = (IID('{967B5AF8-995A-46ED-9E11-35B3C5B9782D}'), 100)
PKEY_Photo_ExposureIndexDenominator = (
    IID('{93112F89-C28B-492F-8A9D-4BE2062CEE8A}'), 100)
PKEY_Photo_ExposureIndexNumerator = (
    IID('{CDEDCF30-8919-44DF-8F4C-4EB2FFDB8D89}'), 100)
PKEY_Photo_ExposureProgram = (
    IID('{14B81DA1-0135-4D31-96D9-6CBFC9671A99}'), 34850)
PKEY_Photo_ExposureProgramText = (
    IID('{FEC690B7-5F30-4646-AE47-4CAAFBA884A3}'), 100)
PKEY_Photo_ExposureTime = (
    IID('{14B81DA1-0135-4D31-96D9-6CBFC9671A99}'), 33434)
PKEY_Photo_ExposureTimeDenominator = (
    IID('{55E98597-AD16-42E0-B624-21599A199838}'), 100)
PKEY_Photo_ExposureTimeNumerator = (
    IID('{257E44E2-9031-4323-AC38-85C552871B2E}'), 100)
...
PKEY_Photo_FlashEnergyDenominator = (
    IID('{D7B61C70-6323-49CD-A5FC-C84277162C97}'), 100)
PKEY_Photo_FlashEnergyNumerator = (
    IID('{FCAD3D3D-0858-400F-AAA3-2F66CCE2A6BC}'), 100)
PKEY_Photo_FlashManufacturer = (
    IID('{AABAF6C9-E0C5-4719-8585-57B103E584FE}'), 100)
...
PKEY_Photo_ShutterSpeed = (
    IID('{14B81DA1-0135-4D31-96D9-6CBFC9671A99}'), 37377)
PKEY_Photo_ShutterSpeedDenominator = (
    IID('{E13D8975-81C7-4948-AE3F-37CAE11E8FF7}'), 100)
PKEY_Photo_ShutterSpeedNumerator = (
    IID('{16EA4042-D6F4-4BCA-8349-7C78D30FB333}'), 100)
PKEY_Photo_SubjectDistance = (
    IID('{14B81DA1-0135-4D31-96D9-6CBFC9671A99}'), 37382)
PKEY_Photo_SubjectDistanceDenominator = (
    IID('{0C840A88-B043-466D-9766-D4B26DA3FA77}'), 100)
PKEY_Photo_SubjectDistanceNumerator = (
    IID('{8AF4961C-F526-43E5-AA81-DB768219178D}'), 100)
PKEY_Photo_TranscodedForSync = (
    IID('{9A8EBB75-6458-4E82-BACB-35C0095B03BB}'), 100)
PKEY_Photo_WhiteBalance = (IID('{EE3D3D8A-5381-4CFA-B13B-AAF66B5F4EC9}'), 100)
PKEY_Photo_WhiteBalanceText = (
    IID('{6336B95E-C7A7-426D-86FD-7AE3D39C84B4}'), 100)
...
PKEY_PropGroup_Description = (
    IID('{8969B275-9475-4E00-A887-FF93B8B41E44}'), 100)
PKEY_PropGroup_FileSystem = (
    IID('{E3A7D2C1-80FC-4B40-8F34-30EA111BDC2E}'), 100)
...
PKEY_PropGroup_MediaAdvanced = (
    IID('{8859A284-DE7E-4642-99BA-D431D044B1EC}'), 100)
...
PKEY_PropGroup_PhotoAdvanced = (
    IID('{0CB2BF5A-9EE7-4A86-8222-F01E07FDADAF}'), 100)
PKEY_PropGroup_RecordedTV = (
    IID('{E7B33238-6584-4170-A5C0-AC25EFD9DA56}'), 100)
PKEY_PropGroup_Video = (IID('{BEBE0920-7671-4C54-A3EB-49FDDFC191EE}'), 100)
PKEY_PropList_ConflictPrompt = (
    IID('{C9944A21-A406-48FE-8225-AEC7E24C211B}'), 11)
PKEY_PropList_ExtendedTileInfo = (
    IID('{C9944A21-A406-48FE-8225-AEC7E24C211B}'), 9)
PKEY_PropList_FileOperationPrompt = (
    IID('{C9944A21-A406-48FE-8225-AEC7E24C211B}'), 10)
...
PKEY_PropList_NonPersonal = (
    IID('{49D1091F-082E-493F-B23F-D2308AA9668C}'), 100)
PKEY_PropList_PreviewDetails = (
    IID('{C9944A21-A406-48FE-8225-AEC7E24C211B}'), 8)
...
PKEY_PropList_XPDetailsPanel = (
    IID('{F2275480-F782-4291-BD94-F13693513AEC}'), 0)
PKEY_RecordedTV_ChannelNumber = (
    IID('{6D748DE2-8D38-4CC3-AC60-F009B057C557}'), 7)
PKEY_RecordedTV_Credits = (IID('{6D748DE2-8D38-4CC3-AC60-F009B057C557}'), 4)
PKEY_RecordedTV_DateContentExpires = (
    IID('{6D748DE2-8D38-4CC3-AC60-F009B057C557}'), 15)
PKEY_RecordedTV_EpisodeName = (
    IID('{6D748DE2-8D38-4CC3-AC60-F009B057C557}'), 2)
PKEY_RecordedTV_IsATSCContent = (
    IID('{6D748DE2-8D38-4CC3-AC60-F009B057C557}'), 16)
PKEY_RecordedTV_IsClosedCaptioningAvailable = (
    IID('{6D748DE2-8D38-4CC3-AC60-F009B057C557}'), 12)
PKEY_RecordedTV_IsDTVContent = (
    IID('{6D748DE2-8D38-4CC3-AC60-F009B057C557}'), 17)
PKEY_RecordedTV_IsHDContent = (
    IID('{6D748DE2-8D38-4CC3-AC60-F009B057C557}'), 18)
PKEY_RecordedTV_IsRepeatBroadcast = (
    IID('{6D748DE2-8D38-4CC3-AC60-F009B057C557}'), 13)
PKEY_RecordedTV_IsSAP = (IID('{6D748DE2-8D38-4CC3-AC60-F009B057C557}'), 14)
PKEY_RecordedTV_NetworkAffiliation = (
    IID('{2C53C813-FB63-4E22-A1AB-0B331CA1E273}'), 100)
PKEY_RecordedTV_OriginalBroadcastDate = (
    IID('{4684FE97-8765-4842-9C13-F006447B178C}'), 100)
PKEY_RecordedTV_ProgramDescription = (
    IID('{6D748DE2-8D38-4CC3-AC60-F009B057C557}'), 3)
PKEY_RecordedTV_RecordingTime = (
    IID('{A5477F61-7A82-4ECA-9DDE-98B69B2479B3}'), 100)
PKEY_RecordedTV_StationCallSign = (
    IID('{6D748DE2-8D38-4CC3-AC60-F009B057C557}'), 5)
PKEY_RecordedTV_StationName = (
    IID('{1B5439E7-EBA1-4AF8-BDD7-7AF1D4549493}'), 100)
PKEY_Search_AutoSummary = (IID('{560C36C0-503A-11CF-BAA1-00004C752A9A}'), 2)
PKEY_Search_ContainerHash = (
    IID('{BCEEE283-35DF-4D53-826A-F36A3EEFC6BE}'), 100)
...
PKEY_Search_IsClosedDirectory = (
    IID('{0B63E343-9CCC-11D0-BCDB-00805FCCCE04}'), 23)
PKEY_Search_IsFullyContained = (
    IID('{0B63E343-9CCC-11D0-BCDB-00805FCCCE04}'), 24)
PKEY_Search_QueryFocusedSummary = (
    IID('{560C36C0-503A-11CF-BAA1-00004C752A9A}'), 3)
...
PKEY_Sync_ConflictDescription = (
    IID('{CE50C159-2FB8-41FD-BE68-D3E042E274BC}'), 4)
PKEY_Sync_ConflictFirstLocation = (
    IID('{CE50C159-2FB8-41FD-BE68-D3E042E274BC}'), 6)
PKEY_Sync_ConflictSecondLocation = (
    IID('{CE50C159-2FB8-41FD-BE68-D3E042E274BC}'), 7)
PKEY_Sync_HandlerCollectionID = (
    IID('{7BD5533E-AF15-44DB-B8C8-BD6624E1D032}'), 2)
...
PKEY_Task_BillingInformation = (
    IID('{D37D52C6-261C-4303-82B3-08B926AC6F12}'), 100)
PKEY_Task_CompletionStatus = (
    IID('{084D8A0A-E6D5-40DE-BF1F-C8820E7C877C}'), 100)
...
PKEY_Video_HorizontalAspectRatio = (
    IID('{64440491-4C8B-11D1-8B70-080036B11A03}'), 42)
...
PKEY_Video_VerticalAspectRatio = (
    IID('{64440491-4C8B-11D1-8B70-080036B11A03}'), 45)
...
PKEY_AppUserModel_RelaunchCommand = (
    IID('{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}'), 2)
PKEY_AppUserModel_RelaunchIconResource = (
    IID('{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}'), 3)
PKEY_AppUserModel_RelaunchDisplayNameResource = (
    IID('{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}'), 4)
PKEY_AppUserModel_ID = (IID('{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}'), 5)
PKEY_AppUserModel_IsDestListSeparator = (
    IID('{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}'), 6)
PKEY_AppUserModel_ExcludeFromShowInNewInstall = (
    IID('{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}'), 8)
PKEY_AppUserModel_PreventPinning = (
    IID('{9F4C2855-9F79-4B39-A8D0-E1D42DE1D5F3}'), 9)
