...
PyIEnumDebugStackFrames::PyIEnumDebugStackFrames(IUnknown *pdisp) : PyIUnknown(pdisp) { ob_type = &type; }
...
// @pymethod <o PyIEnumDebugStackFrames>|PyIEnumDebugStackFrames|Clone|Creates another enumerator that contains the same
...
static struct PyMethodDef PyIEnumDebugStackFrames_methods[] = {
    {"Next", PyIEnumDebugStackFrames::Next,
    ...
    {"Clone", PyIEnumDebugStackFrames::Clone,
     1},  // @pymeth Clone|Creates another enumerator that contains the same enumeration state as the current one.
    {NULL}};

PyComTypeObject PyIEnumDebugStackFrames::type("PyIEnumDebugStackFrames", &PyIUnknown::type,
                                              sizeof(PyIEnumDebugStackFrames), PyIEnumDebugStackFrames_methods,
