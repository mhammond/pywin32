...
class PyGMachineDebugManagerEvents : public PyGatewayBase, public IMachineDebugManagerEvents {
   protected:
    ...
    STDMETHOD(onAddApplication)(IRemoteDebugApplication __RPC_FAR *pda, DWORD dwAppCookie);

    STDMETHOD(onRemoveApplication)(IRemoteDebugApplication __RPC_FAR *pda, DWORD dwAppCookie);
};
