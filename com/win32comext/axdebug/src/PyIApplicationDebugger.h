...
class PyGApplicationDebugger : public PyGatewayBase, public IApplicationDebugger {
   protected:
    ...
    (IRemoteDebugApplicationThread __RPC_FAR *prpt, BREAKREASON br, IActiveScriptErrorDebug __RPC_FAR *pError);

    STDMETHOD(onClose)(void);

    STDMETHOD(onDebuggerEvent)(REFIID riid, IUnknown *punk);
};
