...
class DebugStackFrame:
    ...
    _public_methods_ = ['GetCodeContext', 'GetDescriptionString',
                        'GetLanguageString', 'GetThread', 'GetDebugProperty']
...
class DebugDocumentHost:
    ...
    """
    _public_methods_ = ['GetDeferredText', 'GetScriptTextAttributes',
                        'OnCreateDocumentContext', 'GetPathName', 'GetFileName', 'NotifyChanged']
...
class DebugDocumentTextConnectServer:
    _public_methods_ = win32com.server.connect.IConnectionPointContainer_methods + \
    ...
    def Advise(self, pUnk):
        ...
        interface = pUnk.QueryInterface(
            axdebug.IID_IDebugDocumentTextEvents, 1)
...
class RemoteDebugApplicationEvents:
    _public_methods_ = ["OnConnectDebugger", "OnDisconnectDebugger", "OnSetName", "OnDebugOutput", "OnClose",
                        "OnEnterBreakPoint", "OnLeaveBreakPoint", "OnCreateThread", "OnDestroyThread", "OnBreakFlagChange"]
...
class DebugExpression:
    _public_methods_ = ["Start", "Abort", "QueryIsComplete",
                        "GetResultAsString", "GetResultAsDebugProperty"]
