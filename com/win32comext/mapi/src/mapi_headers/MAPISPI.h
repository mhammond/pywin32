...
typedef HRESULT(STDMETHODCALLTYPE PREPROCESSMESSAGE)(LPVOID lpvSession, LPMESSAGE lpMessage, LPADRBOOK lpAdrBook,
                                                     LPMAPIFOLDER lpFolder, LPALLOCATEBUFFER AllocateBuffer,
                                                     LPALLOCATEMORE AllocateMore, LPFREEBUFFER FreeBuffer,
                                                     ULONG FAR *lpcOutbound, LPMESSAGE FAR *FAR *lpppMessage,
...
#define MAPI_IMAPISUPPORT_METHODS1(IPURE)                                                                       \
    ...
    (THIS_ LPALLOCATEBUFFER FAR * lpAllocateBuffer, LPALLOCATEMORE FAR * lpAllocateMore,                        \
     LPFREEBUFFER FAR * lpFreeBuffer) IPURE;                                                                    \
    MAPIMETHOD(Subscribe)                                                                                       \
    (THIS_ LPNOTIFKEY lpKey, ULONG ulEventMask, ULONG ulFlags, LPMAPIADVISESINK lpAdviseSink,                   \
     ULONG_PTR FAR * lpulConnection) IPURE;                                                                     \
    MAPIMETHOD(Unsubscribe)                                                                                     \
    (THIS_ ULONG_PTR ulConnection) IPURE;                                                                       \
    MAPIMETHOD(Notify)                                                                                          \
    (THIS_ LPNOTIFKEY lpKey, ULONG cNotification, LPNOTIFICATION lpNotifications, ULONG FAR * lpulFlags) IPURE; \
    MAPIMETHOD(ModifyStatusRow)                                                                                 \
    (THIS_ ULONG cValues, LPSPropValue lpColumnVals, ULONG ulFlags) IPURE;                                      \
    MAPIMETHOD(OpenProfileSection)                                                                              \
    (THIS_ LPMAPIUID lpUid, ULONG ulFlags, LPPROFSECT FAR * lppProfileObj) IPURE;                               \
    MAPIMETHOD(RegisterPreprocessor)                                                                            \
    (THIS_ LPMAPIUID lpMuid, LPTSTR lpszAdrType, LPTSTR lpszDLLName, LPSTR /* String8! */ lpszPreprocess,       \
     LPSTR /* String8! */ lpszRemovePreprocessInfo, ULONG ulFlags) IPURE;                                       \
    MAPIMETHOD(NewUID)                                                                                          \
    (THIS_ LPMAPIUID lpMuid) IPURE;                                                                             \
    MAPIMETHOD(MakeInvalid)                                                                                     \
    (THIS_ ULONG ulFlags, LPVOID lpObject, ULONG ulRefCount, ULONG cMethods) IPURE;

#define MAPI_IMAPISUPPORT_METHODS2(IPURE)                                                                              \
    MAPIMETHOD(SpoolerYield)                                                                                           \
    (THIS_ ULONG ulFlags) IPURE;                                                                                       \
    MAPIMETHOD(SpoolerNotify)                                                                                          \
    (THIS_ ULONG ulFlags, LPVOID lpvData) IPURE;                                                                       \
    ...
    (THIS_ LPMAPIUID lpProviderID, ULONG ulFlags) IPURE;                                                               \
    MAPIMETHOD(CompareEntryIDs)                                                                                        \
    (THIS_ ULONG cbEntry1, LPENTRYID lpEntry1, ULONG cbEntry2, LPENTRYID lpEntry2, ULONG ulCompareFlags,               \
     ULONG FAR * lpulResult) IPURE;                                                                                    \
    MAPIMETHOD(OpenTemplateID)                                                                                         \
    (THIS_ ULONG cbTemplateID, LPENTRYID lpTemplateID, ULONG ulTemplateFlags, LPMAPIPROP lpMAPIPropData,               \
     LPCIID lpInterface, LPMAPIPROP FAR * lppMAPIPropNew, LPMAPIPROP lpMAPIPropSibling) IPURE;                         \
    MAPIMETHOD(OpenEntry)                                                                                              \
    (THIS_ ULONG cbEntryID, LPENTRYID lpEntryID, LPCIID lpInterface, ULONG ulOpenFlags, ULONG FAR * lpulObjType,       \
    ...
    MAPIMETHOD(Details)                                                                                                \
    (THIS_ ULONG_PTR FAR * lpulUIParam, LPFNDISMISS lpfnDismiss, LPVOID lpvDismissContext, ULONG cbEntryID,            \
    ...
    (THIS_ ULONG_PTR ulUIParam, ULONG ulFlags, LPTSTR lpszTitle, LPMAPITABLE lpDisplayTable, LPMAPIPROP lpCOnfigData,  \
     ULONG ulTopPage) IPURE;                                                                                           \
    MAPIMETHOD(CopyMessages)                                                                                           \
    (THIS_ LPCIID lpSrcInterface, LPVOID lpSrcFolder, LPENTRYLIST lpMsgList, LPCIID lpDestInterface,                   \
     LPVOID lpDestFolder, ULONG_PTR ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags) IPURE;                        \
    MAPIMETHOD(CopyFolder)                                                                                             \
    (THIS_ LPCIID lpSrcInterface, LPVOID lpSrcFolder, ULONG cbEntryID, LPENTRYID lpEntryID, LPCIID lpDestInterface,    \
     LPVOID lpDestFolder, LPTSTR lszNewFolderName, ULONG_PTR ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags)      \
        IPURE;

#define MAPI_IMAPISUPPORT_METHODS3(IPURE)                                                                           \
    MAPIMETHOD(DoCopyTo)                                                                                            \
    (THIS_ LPCIID lpSrcInterface, LPVOID lpSrcObj, ULONG ciidExclude, LPCIID rgiidExclude,                          \
     LPSPropTagArray lpExcludeProps, ULONG_PTR ulUIParam, LPMAPIPROGRESS lpProgress, LPCIID lpDestInterface,        \
     LPVOID lpDestObj, ULONG ulFlags, LPSPropProblemArray FAR * lppProblems) IPURE;                                 \
    MAPIMETHOD(DoCopyProps)                                                                                         \
    (THIS_ LPCIID lpSrcInterface, LPVOID lpSrcObj, LPSPropTagArray lpIncludeProps, ULONG_PTR ulUIParam,             \
    ...
    (THIS_ ULONG_PTR ulUIParam, ULONG ulFlags, LPMAPIPROGRESS FAR * lppProgress) IPURE;                             \
    MAPIMETHOD(ReadReceipt)                                                                                         \
    (THIS_ ULONG ulFlags, LPMESSAGE lpReadMessage, LPMESSAGE FAR * lppEmptyMessage) IPURE;                          \
    MAPIMETHOD(PrepareSubmit)                                                                                       \
    (THIS_ LPMESSAGE lpMessage, ULONG FAR * lpulFlags) IPURE;                                                       \
    MAPIMETHOD(ExpandRecips)                                                                                        \
    (THIS_ LPMESSAGE lpMessage, ULONG FAR * lpulFlags) IPURE;                                                       \
    MAPIMETHOD(UpdatePAB)                                                                                           \
    (THIS_ ULONG ulFlags, LPMESSAGE lpMessage) IPURE;                                                               \
    MAPIMETHOD(DoSentMail)                                                                                          \
    (THIS_ ULONG ulFlags, LPMESSAGE lpMessage) IPURE;                                                               \
    MAPIMETHOD(OpenAddressBook)                                                                                     \
    (THIS_ LPCIID lpInterface, ULONG ulFlags, LPADRBOOK FAR * lppAdrBook) IPURE;                                    \
    ...
    (THIS_ LPMESSAGE lpMessage, LPADRLIST lpRecipList) IPURE;                                                       \
    MAPIMETHOD(WrapStoreEntryID)                                                                                    \
    (THIS_ ULONG cbOrigEntry, LPENTRYID lpOrigEntry, ULONG FAR * lpcbWrappedEntry, LPENTRYID FAR * lppWrappedEntry) \
        IPURE;                                                                                                      \
    MAPIMETHOD(ModifyProfile)                                                                                       \
    (THIS_ ULONG ulFlags) IPURE;                                                                                    \
    MAPIMETHOD(IStorageFromStream)                                                                                  \
    (THIS_ LPUNKNOWN lpUnkIn, LPCIID lpInterface, ULONG ulFlags, LPSTORAGE FAR * lppStorageOut) IPURE;              \
    MAPIMETHOD(GetSvcConfigSupportObj)                                                                              \
    (THIS_ ULONG ulFlags, LPMAPISUP FAR * lppSvcSupport) IPURE;

#undef INTERFACE
#define INTERFACE IMAPISupport
DECLARE_MAPI_INTERFACE_(IMAPISupport, IUnknown){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                    MAPI_IMAPISUPPORT_METHODS1(PURE) MAPI_IMAPISUPPORT_METHODS2(PURE)
...
#define MAPI_IABPROVIDER_METHODS(IPURE)                                                      \
    ...
    (THIS_ ULONG FAR * lpulFlags) IPURE;                                                     \
    MAPIMETHOD(Logon)                                                                        \
    (THIS_ LPMAPISUP lpMAPISup, ULONG_PTR ulUIParam, LPTSTR lpszProfileName, ULONG ulFlags,  \
     ULONG FAR * lpulpcbSecurity, LPBYTE FAR * lppbSecurity, LPMAPIERROR FAR * lppMAPIError, \
     LPABLOGON FAR * lppABLogon) IPURE;

#undef INTERFACE
#define INTERFACE IABProvider
DECLARE_MAPI_INTERFACE_(IABProvider,
                        IUnknown){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IABPROVIDER_METHODS(PURE)};
...
#define MAPI_IABLOGON_METHODS(IPURE)                                                                         \
    ...
    (THIS_ LPCIID lpInterface, ULONG ulFlags, ULONG FAR * lpulObjType, LPMAPISTATUS FAR * lppEntry) IPURE;   \
    MAPIMETHOD(OpenTemplateID)                                                                               \
    (THIS_ ULONG cbTemplateID, LPENTRYID lpTemplateID, ULONG ulTemplateFlags, LPMAPIPROP lpMAPIPropData,     \
     LPCIID lpInterface, LPMAPIPROP FAR * lppMAPIPropNew, LPMAPIPROP lpMAPIPropSibling) IPURE;               \
    MAPIMETHOD(GetOneOffTable)                                                                               \
...
DECLARE_MAPI_INTERFACE_(IABLogon, IUnknown){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IABLOGON_METHODS(PURE)};

typedef HRESULT(STDMAPIINITCALLTYPE ABPROVIDERINIT)(HINSTANCE hInstance, LPMALLOC lpMalloc,
...
#define MAPI_IXPPROVIDER_METHODS(IPURE)                                                                  \
    ...
    (THIS_ LPMAPISUP lpMAPISup, ULONG_PTR ulUIParam, __in LPTSTR lpszProfileName, ULONG FAR * lpulFlags, \
     LPMAPIERROR FAR * lppMAPIError, LPXPLOGON FAR * lppXPLogon) IPURE;

#undef INTERFACE
#define INTERFACE IXPProvider
DECLARE_MAPI_INTERFACE_(IXPProvider,
                        IUnknown){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IXPPROVIDER_METHODS(PURE)};
...
typedef SCODE(STDMAPIINITCALLTYPE OPTIONCALLBACK)(HINSTANCE hInst, LPMALLOC lpMalloc, ULONG ulFlags, ULONG cbOptionData,
                                                  LPBYTE lpbOptionData, LPMAPISUP lpMAPISup, LPMAPIPROP lpDataSource,
                                                  LPMAPIPROP FAR *lppWrappedSource, LPMAPIERROR FAR *lppMAPIError);
...
#define MAPI_IXPLOGON_METHODS(IPURE)                                                                              \
    ...
    (THIS_ ULONG FAR * lpulFlags, ULONG FAR * lpcAdrType,                                                         \
     __deref_out_ecount_full(*lpcAdrType) LPTSTR FAR * FAR * lpppAdrTypeArray, ULONG FAR * lpcMAPIUID,            \
     LPMAPIUID FAR * FAR * lpppUIDArray) IPURE;                                                                   \
    MAPIMETHOD(RegisterOptions)                                                                                   \
    (THIS_ ULONG FAR * lpulFlags, ULONG FAR * lpcOptions, LPOPTIONDATA FAR * lppOptions) IPURE;                   \
    MAPIMETHOD(TransportNotify)                                                                                   \
    (THIS_ ULONG FAR * lpulFlags, LPVOID FAR * lppvData) IPURE;                                                   \
    MAPIMETHOD(Idle)                                                                                              \
    (THIS_ ULONG ulFlags) IPURE;                                                                                  \
    MAPIMETHOD(TransportLogoff)                                                                                   \
    (THIS_ ULONG ulFlags) IPURE;                                                                                  \
    MAPIMETHOD(SubmitMessage)                                                                                     \
    (THIS_ ULONG ulFlags, LPMESSAGE lpMessage, ULONG_PTR FAR * lpulMsgRef, ULONG_PTR FAR * lpulReturnParm) IPURE; \
    MAPIMETHOD(EndMessage)                                                                                        \
    (THIS_ ULONG_PTR ulMsgRef, ULONG FAR * lpulFlags) IPURE;                                                      \
    MAPIMETHOD(Poll)                                                                                              \
    (THIS_ ULONG FAR * lpulIncoming) IPURE;                                                                       \
    MAPIMETHOD(StartMessage)                                                                                      \
    (THIS_ ULONG ulFlags, LPMESSAGE lpMessage, ULONG_PTR FAR * lpulMsgRef) IPURE;                                 \
    MAPIMETHOD(OpenStatusEntry)                                                                                   \
    (THIS_ LPCIID lpInterface, ULONG ulFlags, ULONG FAR * lpulObjType, LPMAPISTATUS FAR * lppEntry) IPURE;        \
    MAPIMETHOD(ValidateState)                                                                                     \
    (THIS_ ULONG_PTR ulUIParam, ULONG ulFlags) IPURE;                                                             \
    MAPIMETHOD(FlushQueues)                                                                                       \
    (THIS_ ULONG_PTR ulUIParam, ULONG cbTargetTransport, LPENTRYID lpTargetTransport, ULONG ulFlags) IPURE;

#undef INTERFACE
#define INTERFACE IXPLogon
DECLARE_MAPI_INTERFACE_(IXPLogon, IUnknown){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IXPLOGON_METHODS(PURE)};

/* Transport Provider Entry Point */

typedef HRESULT(STDMAPIINITCALLTYPE XPPROVIDERINIT)(HINSTANCE hInstance, LPMALLOC lpMalloc,
                                                    LPALLOCATEBUFFER lpAllocateBuffer, LPALLOCATEMORE lpAllocateMore,
                                                    LPFREEBUFFER lpFreeBuffer, ULONG ulFlags, ULONG ulMAPIVer,
                                                    ULONG FAR *lpulProviderVer, LPXPPROVIDER FAR *lppXPProvider);
...
#define MAPI_IMSPROVIDER_METHODS(IPURE)                                                                            \
    ...
    (THIS_ ULONG FAR * lpulFlags) IPURE;                                                                           \
    MAPIMETHOD(Logon)                                                                                              \
    (THIS_ LPMAPISUP lpMAPISup, ULONG_PTR ulUIParam, LPTSTR lpszProfileName, ULONG cbEntryID, LPENTRYID lpEntryID, \
     ULONG ulFlags, LPCIID lpInterface, ULONG FAR * lpcbSpoolSecurity, LPBYTE FAR * lppbSpoolSecurity,             \
     LPMAPIERROR FAR * lppMAPIError, LPMSLOGON FAR * lppMSLogon, LPMDB FAR * lppMDB) IPURE;                        \
    MAPIMETHOD(SpoolerLogon)                                                                                       \
    (THIS_ LPMAPISUP lpMAPISup, ULONG_PTR ulUIParam, LPTSTR lpszProfileName, ULONG cbEntryID, LPENTRYID lpEntryID, \
     ULONG ulFlags, LPCIID lpInterface, ULONG cbSpoolSecurity, LPBYTE lpbSpoolSecurity,                            \
     LPMAPIERROR FAR * lppMAPIError, LPMSLOGON FAR * lppMSLogon, LPMDB FAR * lppMDB) IPURE;                        \
...
DECLARE_MAPI_INTERFACE_(IMSProvider,
                        IUnknown){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMSPROVIDER_METHODS(PURE)};
...
#define MAPI_IMSLOGON_METHODS(IPURE)                                                                         \
    ...
    (THIS_ ULONG_PTR ulConnection) IPURE;                                                                    \
    MAPIMETHOD(OpenStatusEntry)                                                                              \
    (THIS_ LPCIID lpInterface, ULONG ulFlags, ULONG FAR * lpulObjType, LPVOID FAR * lppEntry) IPURE;

#undef INTERFACE
#define INTERFACE IMSLogon
DECLARE_MAPI_INTERFACE_(IMSLogon, IUnknown){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMSLOGON_METHODS(PURE)};

/* Message Store Provider Entry Point */

typedef HRESULT(STDMAPIINITCALLTYPE MSPROVIDERINIT)(HINSTANCE hInstance,
                                                    ...
                                                    ULONG ulFlags, ULONG ulMAPIVer, ULONG FAR *lpulProviderVer,
...
typedef HRESULT(STDAPICALLTYPE MSGSERVICEENTRY)(HINSTANCE hInstance, LPMALLOC lpMalloc, LPMAPISUP lpMAPISup,
                                                ULONG_PTR ulUIParam, ULONG ulFlags, ULONG ulContext, ULONG cValues,
