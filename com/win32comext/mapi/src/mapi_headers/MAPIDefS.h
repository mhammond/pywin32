...
#define MAPI_IMAPIPROP_METHODS(IPURE)                                                                             \
    ...
    MAPIMETHOD(CopyTo)                                                                                            \
    (THIS_ ULONG ciidExclude, LPCIID rgiidExclude, LPSPropTagArray lpExcludeProps, ULONG_PTR ulUIParam,           \
    ...
    (THIS_ LPSPropTagArray lpIncludeProps, ULONG_PTR ulUIParam, LPMAPIPROGRESS lpProgress, LPCIID lpInterface,    \
...
DECLARE_MAPI_INTERFACE_(IMAPIProp, IUnknown){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIPROP_METHODS(PURE)};
...
#define MAPI_IMAPITABLE_METHODS(IPURE)                                                                          \
    ...
    (THIS_ HRESULT hResult, ULONG ulFlags, LPMAPIERROR FAR * lppMAPIError) IPURE;                               \
    MAPIMETHOD(Advise)                                                                                          \
    (THIS_ ULONG ulEventMask, LPMAPIADVISESINK lpAdviseSink, ULONG_PTR FAR * lpulConnection) IPURE;             \
    MAPIMETHOD(Unadvise)                                                                                        \
...
DECLARE_MAPI_INTERFACE_(IProfSect, IMAPIProp){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIPROP_METHODS(PURE)
...
DECLARE_MAPI_INTERFACE_(IMAPIStatus, IMAPIProp){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIPROP_METHODS(PURE)
...
DECLARE_MAPI_INTERFACE_(IMAPIContainer, IMAPIProp){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                       MAPI_IMAPIPROP_METHODS(PURE) MAPI_IMAPICONTAINER_METHODS(PURE)};
...
#define MAPI_IABCONTAINER_METHODS(IPURE)                                                                        \
    ...
    (THIS_ LPENTRYLIST lpEntries, ULONG_PTR ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags) IPURE;         \
...
DECLARE_MAPI_INTERFACE_(IABContainer, IMAPIContainer){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                          MAPI_IMAPIPROP_METHODS(PURE) MAPI_IMAPICONTAINER_METHODS(PURE)
...
DECLARE_MAPI_INTERFACE_(IMailUser, IMAPIProp){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIPROP_METHODS(PURE)
...
#define MAPI_IMAPIFOLDER_METHODS(IPURE)                                                                                \
    ...
    (THIS_ LPENTRYLIST lpMsgList, LPCIID lpInterface, LPVOID lpDestFolder, ULONG_PTR ulUIParam,                        \
     LPMAPIPROGRESS lpProgress, ULONG ulFlags) IPURE;                                                                  \
    MAPIMETHOD(DeleteMessages)                                                                                         \
    (THIS_ LPENTRYLIST lpMsgList, ULONG_PTR ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags) IPURE;                \
    ...
    (THIS_ ULONG cbEntryID, LPENTRYID lpEntryID, LPCIID lpInterface, LPVOID lpDestFolder, LPTSTR lpszNewFolderName,    \
     ULONG_PTR ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags) IPURE;                                             \
    MAPIMETHOD(DeleteFolder)                                                                                           \
    (THIS_ ULONG cbEntryID, LPENTRYID lpEntryID, ULONG_PTR ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags) IPURE; \
    ...
    (THIS_ ULONG_PTR ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags) IPURE;

#undef INTERFACE
#define INTERFACE IMAPIFolder
DECLARE_MAPI_INTERFACE_(IMAPIFolder, IMAPIContainer){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE)
                                                         MAPI_IMAPIPROP_METHODS(PURE) MAPI_IMAPICONTAINER_METHODS(PURE)
...
DECLARE_MAPI_INTERFACE_(IMsgStore, IMAPIProp){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIPROP_METHODS(PURE)
...
#define MAPI_IMESSAGE_METHODS(IPURE)                                                                          \
    ...
    (THIS_ ULONG ulAttachmentNum, ULONG_PTR ulUIParam, LPMAPIPROGRESS lpProgress, ULONG ulFlags) IPURE;       \
...
DECLARE_MAPI_INTERFACE_(IMessage, IMAPIProp){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIPROP_METHODS(PURE)
...
DECLARE_MAPI_INTERFACE_(IAttach, IMAPIProp){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIPROP_METHODS(PURE)
...
typedef SCODE(STDMETHODCALLTYPE FAR *LPFNBUTTON)(ULONG_PTR ulUIParam, LPVOID lpvContext, ULONG cbEntryID,
...
#define MAPI_IMAPICONTROL_METHODS(IPURE)                                          \
    ...
    (THIS_ HRESULT hResult, ULONG ulFlags, LPMAPIERROR FAR * lppMAPIError) IPURE; \
    MAPIMETHOD(Activate)                                                          \
    (THIS_ ULONG ulFlags, ULONG_PTR ulUIParam) IPURE;                             \
    MAPIMETHOD(GetState)                                                          \
...
#define MAPI_IPROVIDERADMIN_METHODS(IPURE)                                                               \
    ...
    (THIS_ LPTSTR lpszProvider, ULONG cValues, LPSPropValue lpProps, ULONG_PTR ulUIParam, ULONG ulFlags, \
...
DECLARE_MAPI_INTERFACE_(IMAPIClientShutdown,
                        IUnknown){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPICLIENTSHUTDOWN_METHODS(PURE)};
...
DECLARE_MAPI_INTERFACE_(IMAPIProviderShutdown,
                        IUnknown){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIPROVIDERSHUTDOWN_METHODS(PURE)};
