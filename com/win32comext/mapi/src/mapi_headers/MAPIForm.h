...
#define MAPI_GETLASTERROR_METHOD(IPURE) \
    ...
    (THIS_ /*in*/ HRESULT hResult, /*in*/ ULONG ulFlags, /*out*/ LPMAPIERROR FAR * lppMAPIError) IPURE;
...
#define MAPI_IPERSISTMESSAGE_METHODS(IPURE)                                                                \
    ...
    MAPIMETHOD(Load)                                                                                       \
    (THIS_ /*in*/ LPMAPIMESSAGESITE pMessageSite, /*in*/ LPMESSAGE pMessage, /*in*/ ULONG ulMessageStatus, \
...
DECLARE_MAPI_INTERFACE_(IPersistMessage, IUnknown){
    BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_GETLASTERROR_METHOD(PURE) MAPI_IPERSISTMESSAGE_METHODS(PURE)};
...
#define MAPI_IMAPIMESSAGESITE_METHODS(IPURE)                                                                         \
    ...
    (THIS_ /*in*/ ULONG fComposeInFolder, /*in*/ LPMAPIFOLDER pFolderFocus, /*in*/ LPPERSISTMESSAGE pPersistMessage, \
     /*out*/ LPMESSAGE FAR * ppMessage, /*out*/ LPMAPIMESSAGESITE FAR * ppMessageSite,                               \
    ...
    (THIS_ /*in*/ LPMAPIFOLDER pFolderDestination, /*in*/ LPMAPIVIEWCONTEXT pViewContext, /*in*/ LPCRECT prcPosRect) \
        IPURE;                                                                                                       \
...
DECLARE_MAPI_INTERFACE_(IMAPIMessageSite, IUnknown){
    BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_GETLASTERROR_METHOD(PURE) MAPI_IMAPIMESSAGESITE_METHODS(PURE)};
...
#define MAPI_IMAPIFORM_METHODS(IPURE)                                                                                \
    ...
    MAPIMETHOD(DoVerb)                                                                                               \
    (THIS_ /*in*/ LONG iVerb, /*in*/ LPMAPIVIEWCONTEXT lpViewContext, /* can be null */ /*in*/ ULONG_PTR hwndParent, \
     /*in*/ LPCRECT lprcPosRect) IPURE;                                                                              \
    MAPIMETHOD(Advise)(THIS_ /*in*/ LPMAPIVIEWADVISESINK pAdvise, /*out*/ ULONG_PTR FAR * pdwStatus) IPURE;          \
    MAPIMETHOD(Unadvise)(THIS_ /*in*/ ULONG_PTR ulConnection) IPURE;
...
typedef enum tagSAVEOPTS { SAVEOPTS_SAVEIFDIRTY = 0, SAVEOPTS_NOSAVE = 1, SAVEOPTS_PROMPTSAVE = 2 } SAVEOPTS;
...
#define MAPI_IMAPIVIEWCONTEXT_METHODS(IPURE)                                                                       \
    ...
    (THIS_ /*out*/ ULONG FAR * pulFlags, /*out*/ ULONG FAR * pulFormat, /*out*/ LPSTREAM FAR * ppstm) IPURE;       \
...
DECLARE_MAPI_INTERFACE_(IMAPIViewContext, IUnknown){
    BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_GETLASTERROR_METHOD(PURE) MAPI_IMAPIVIEWCONTEXT_METHODS(PURE)};
...
#define MAPI_IMAPIFORMADVISESINK_METHODS(IPURE)                                                       \
    ...
    (THIS_ /*in*/ LPCSTR lpszMessageClass, /*in*/ ULONG ulMessageStatus, /*in*/ ULONG ulMessageFlags, \
...
#define MAPI_IMAPIFORMMGR_METHODS(IPURE)                                                                        \
    MAPIMETHOD(LoadForm)                                                                                        \
    (THIS_ /*in*/ ULONG_PTR ulUIParam, /*in*/ ULONG ulFlags, /*in*/ LPCSTR lpszMessageClass,                    \
     /*in*/ ULONG ulMessageStatus, /*in*/ ULONG ulMessageFlags, /*in*/ LPMAPIFOLDER pFolderFocus,               \
     /*in*/ LPMAPIMESSAGESITE pMessageSite, /*in*/ LPMESSAGE pmsg, /*in*/ LPMAPIVIEWCONTEXT pViewContext,       \
     /*in*/ REFIID riid, /*out*/ LPVOID FAR * ppvObj) IPURE;                                                    \
    MAPIMETHOD(ResolveMessageClass)                                                                             \
    (THIS_ /*in*/ LPCSTR szMsgClass, /*in*/ ULONG ulFlags, /*in*/ LPMAPIFOLDER pFolderFocus,                    \
     /* can be null */ /*out*/ LPMAPIFORMINFO FAR * ppResult) IPURE;                                            \
    MAPIMETHOD(ResolveMultipleMessageClasses)                                                                   \
    (THIS_ /*in*/ LPSMESSAGECLASSARRAY pMsgClasses, /*in*/ ULONG ulFlags, /*in*/ LPMAPIFOLDER pFolderFocus,     \
     /* can be null */ /*out*/ LPSMAPIFORMINFOARRAY FAR * pfrminfoarray) IPURE;                                 \
    MAPIMETHOD(CalcFormPropSet)                                                                                 \
    (THIS_ /*in*/ LPSMAPIFORMINFOARRAY pfrminfoarray, /*in*/ ULONG ulFlags,                                     \
     /*out*/ LPMAPIFORMPROPARRAY FAR * ppResults) IPURE;                                                        \
    MAPIMETHOD(CreateForm)                                                                                      \
    (THIS_ /*in*/ ULONG_PTR ulUIParam, /*in*/ ULONG ulFlags, /*in*/ LPMAPIFORMINFO pfrminfoToActivate,          \
     /*in*/ REFIID refiidToAsk, /*out*/ LPVOID FAR * ppvObj) IPURE;                                             \
    MAPIMETHOD(SelectForm)                                                                                      \
    (THIS_ /*in*/ ULONG_PTR ulUIParam, /*in*/ ULONG ulFlags, /*in*/ LPCTSTR pszTitle, /*in*/ LPMAPIFOLDER pfld, \
     /*out*/ LPMAPIFORMINFO FAR * ppfrminfoReturned) IPURE;                                                     \
    MAPIMETHOD(SelectMultipleForms)                                                                             \
    (THIS_ /*in*/ ULONG_PTR ulUIParam, /*in*/ ULONG ulFlags, /*in*/ LPCTSTR pszTitle, /*in*/ LPMAPIFOLDER pfld, \
     /*in*/ LPSMAPIFORMINFOARRAY pfrminfoarray, /*out*/ LPSMAPIFORMINFOARRAY FAR * ppfrminfoarray) IPURE;       \
    MAPIMETHOD(SelectFormContainer)                                                                             \
    (THIS_ /*in*/ ULONG_PTR ulUIParam, /*in*/ ULONG ulFlags, /*out*/ LPMAPIFORMCONTAINER FAR * lppfcnt) IPURE;  \
    MAPIMETHOD(OpenFormContainer)                                                                               \
    (THIS_ /*in*/ HFRMREG hfrmreg, /*in*/ LPUNKNOWN lpunk, /*out*/ LPMAPIFORMCONTAINER FAR * lppfcnt) IPURE;    \
    MAPIMETHOD(PrepareForm)                                                                                     \
    (THIS_ /*in*/ ULONG_PTR ulUIParam, /*in*/ ULONG ulFlags, /*in*/ LPMAPIFORMINFO pfrminfo) IPURE;             \
    MAPIMETHOD(IsInConflict)                                                                                    \
    (THIS_ /*in*/ ULONG ulMessageFlags, /*in*/ ULONG ulMessageStatus, /*in*/ LPCSTR szMessageClass,             \
...
#define MAPI_IMAPIFORMCONTAINER_METHODS(IPURE)                                                                  \
    ...
    (THIS_ /*in*/ ULONG_PTR ulUIParam, /*in*/ ULONG ulFlags, /*in*/ LPCTSTR szCfgPathName) IPURE;               \
    MAPIMETHOD(RemoveForm)(THIS_ /*in*/ LPCSTR szMessageClass) IPURE;                                           \
    MAPIMETHOD(ResolveMessageClass)                                                                             \
    (THIS_ /*in*/ LPCSTR szMessageClass, /*in*/ ULONG ulFlags, /*out*/ LPMAPIFORMINFO FAR * pforminfo) IPURE;   \
    MAPIMETHOD(ResolveMultipleMessageClasses)                                                                   \
    (THIS_ /*in*/ LPSMESSAGECLASSARRAY pMsgClassArray, /*in*/ ULONG ulFlags,                                    \
...
DECLARE_MAPI_INTERFACE_(IMAPIFormContainer, IUnknown){
    BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_GETLASTERROR_METHOD(PURE) MAPI_IMAPIFORMCONTAINER_METHODS(PURE)};

/*-- IMAPIFormFactory ------------------------------------------------------*/

#define MAPI_IMAPIFORMFACTORY_METHODS(IPURE)                                                                     \
    MAPIMETHOD(CreateClassFactory)                                                                               \
    (THIS_ /*in*/ REFCLSID clsidForm, /*in*/ ULONG ulFlags, /*out*/ LPCLASSFACTORY FAR * lppClassFactory) IPURE; \
...
DECLARE_MAPI_INTERFACE_(IMAPIFormFactory, IUnknown){
    BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_GETLASTERROR_METHOD(PURE) MAPI_IMAPIFORMFACTORY_METHODS(PURE)};
