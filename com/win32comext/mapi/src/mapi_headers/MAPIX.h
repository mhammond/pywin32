...
#define MAPI_IMAPISESSION_METHODS(IPURE)                                                                            \
    ...
    (THIS_ ULONG_PTR ulUIParam, LPMDB lpMsgStore, LPMAPIFOLDER lpParentFolder, LPCIID lpInterface,                  \
     ULONG_PTR ulMessageToken, LPMESSAGE lpMessageSent, ULONG ulFlags, ULONG ulMessageStatus, ULONG ulMessageFlags, \
     ULONG ulAccess, LPSTR lpszMessageClass) IPURE;                                                                 \
    MAPIMETHOD(PrepareForm)                                                                                         \
    (THIS_ LPCIID lpInterface, LPMESSAGE lpMessage, ULONG_PTR FAR * lpulMessageToken) IPURE;
...
DECLARE_MAPI_INTERFACE_(IAddrBook, IMAPIProp){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMAPIPROP_METHODS(PURE)
...
DECLARE_MAPI_INTERFACE_(IMsgServiceAdmin,
                        IUnknown){BEGIN_INTERFACE MAPI_IUNKNOWN_METHODS(PURE) MAPI_IMSGSERVICEADMIN_METHODS(PURE)};
