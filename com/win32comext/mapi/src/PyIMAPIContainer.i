...
PyIMAPIContainer::PyIMAPIContainer(IUnknown *pDisp) : PyIMAPIProp(pDisp) { ob_type = &type; }

PyIMAPIContainer::~PyIMAPIContainer() {}

/*static*/ IMAPIContainer *PyIMAPIContainer::GetI(PyObject *self) { return (IMAPIContainer *)PyIUnknown::GetI(self); }
