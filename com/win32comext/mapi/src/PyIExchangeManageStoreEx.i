...
PyIExchangeManageStoreEx::PyIExchangeManageStoreEx(IUnknown *pDisp) : PyIUnknown(pDisp) { ob_type = &type; }
...
/*
** See
*https://learn.microsoft.com/en-ca/archive/blogs/dvespa/a-new-mapi-interface-is-available-to-let-you-force-connections-to-go-to-a-specific-exchange-server
*/
...
PyObject *PyIExchangeManageStoreEx::CreateStoreEntryID2(PyObject *self, PyObject *args)
{
    ...
    Py_BEGIN_ALLOW_THREADS hRes =
        _swig_self->CreateStoreEntryID2(seqLen, pPV, flags, &sbEID.cb, (LPENTRYID *)&sbEID.lpb);
    Py_END_ALLOW_THREADS

        if (FAILED(hRes)) result = OleSetOleError(hRes);
    else result = Py_BuildValue("y#", sbEID.lpb, (Py_ssize_t)sbEID.cb);
