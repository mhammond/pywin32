...
PyIAddrBook::PyIAddrBook(IUnknown *pDisp) : PyIMAPIProp(pDisp) { ob_type = &type; }

PyIAddrBook::~PyIAddrBook() {}

/*static*/ IAddrBook *PyIAddrBook::GetI(PyObject *self) { return (IAddrBook *)PyIUnknown::GetI(self); }
