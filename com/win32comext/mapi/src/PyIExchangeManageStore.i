...
PyIExchangeManageStore::PyIExchangeManageStore(IUnknown *pDisp) : PyIUnknown(pDisp) { ob_type = &type; }
...
PyObject *PyIExchangeManageStore::CreateStoreEntryID(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "OO|l:CreateStoreEntryID", &obServerDN, &obUserDN, &flags))
        return NULL;
    ...
    Py_BEGIN_ALLOW_THREADS hRes =
        _swig_self->CreateStoreEntryID(serverDN, userDN, flags, &sbEID.cb, (LPENTRYID *)&sbEID.lpb);
