...
#define MAPI_ASSOCIATED \
    MAPI_ASSOCIATED  // The container's associated contents table should be returned rather than the standard contents
                     ...
                     // forms and views.
#define MAPI_APP_PROFILE \
    MAPI_APP_PROFILE  // Include "app" profiles in the profile table. If this flag is not set, "app" profiles are not
                      // included. This flag may not be recognized or supported in all MAPI implementations.
...
#define MAPI_NATIVE_BODY \
    MAPI_NATIVE_BODY  // Indicates whether the decompressed stream is also converted to its native body.
...
PyObject *PyWrapCompressedRTFStreamEx(PyObject *self, PyObject *args)
{
    ...
    if (!PyArg_ParseTuple(args, "O|(kkk):PyWrapCompressedRTFStreamEx", &obCompressedStream, &wcsinfo.ulFlags,
