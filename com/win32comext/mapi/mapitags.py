# Copied from com/win32comext/mapi/src/MAPIStubLibrary/include/MAPITags.h
...
PR_SENDER_SMTP_ADDRESS = PROP_TAG(PT_TSTRING, 0x5D01)
PR_SENDER_SMTP_ADDRESS_W = PROP_TAG(PT_UNICODE, 0x5D01)
PR_SENDER_SMTP_ADDRESS_A = PROP_TAG(PT_STRING8, 0x5D01)
PR_SENT_REPRESENTING_SMTP_ADDRESS = PROP_TAG(PT_TSTRING, 0x5D02)
PR_SENT_REPRESENTING_SMTP_ADDRESS_W = PROP_TAG(PT_UNICODE, 0x5D02)
PR_SENT_REPRESENTING_SMTP_ADDRESS_A = PROP_TAG(PT_STRING8, 0x5D02)

PR_RECEIVED_BY_SMTP_ADDRESS = PROP_TAG(PT_TSTRING, 0x5D07)
PR_RECEIVED_BY_SMTP_ADDRESS_W = PROP_TAG(PT_UNICODE, 0x5D07)
PR_RECEIVED_BY_SMTP_ADDRESS_A = PROP_TAG(PT_STRING8, 0x5D07)
PR_RCVD_REPRESENTING_SMTP_ADDRESS = PROP_TAG(PT_TSTRING, 0x5D08)
PR_RCVD_REPRESENTING_SMTP_ADDRESS_W = PROP_TAG(PT_UNICODE, 0x5D08)
PR_RCVD_REPRESENTING_SMTP_ADDRESS_A = PROP_TAG(PT_STRING8, 0x5D08)
