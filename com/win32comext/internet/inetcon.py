INET_E_USE_DEFAULT_PROTOCOLHANDLER = - \
    2146697199  # _HRESULT_TYPEDEF_(0x800C0011L)
...
INET_E_CANNOT_INSTANTIATE_OBJECT = - \
    2146697200  # _HRESULT_TYPEDEF_(0x800C0010L)
...
INET_E_CODE_INSTALL_BLOCKED_BY_HASH_POLICY = - \
    2146695936  # _HRESULT_TYPEDEF_(0x800C0500L)
...
Uri_ENCODING_RFC = (Uri_ENCODING_USER_INFO_AND_PATH_IS_PERCENT_ENCODED_UTF8 |
                    Uri_ENCODING_HOST_IS_PERCENT_ENCODED_UTF8 | Uri_ENCODING_QUERY_AND_FRAGMENT_IS_PERCENT_ENCODED_UTF8)
