...
PyIActiveScriptSite::PyIActiveScriptSite(IUnknown *pDisp) : PyIUnknown(pDisp) { ob_type = &type; }
...
PyComTypeObject PyIActiveScriptSite::type("PyIActiveScriptSite", &PyIUnknown::type, sizeof(PyIActiveScriptSite),
                                          PyIActiveScriptSite_methods, GET_PYCOM_CTOR(PyIActiveScriptSite));
