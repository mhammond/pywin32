...
HRESULT InvokeGatewayViaPolicy(PyGatewayBase *pGateway, const char *szMethodName, EXCEPINFO *pei,
...
static struct PyMethodDef axcom_methods[] = {{NULL, NULL}};
...
{
    PYWIN_MODULE_INIT_PREPARE(axscript, axcom_methods, "A module, encapsulating the ActiveX Scripting interfaces.");
