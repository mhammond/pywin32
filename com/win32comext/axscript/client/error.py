...
class IActiveScriptError:
    ...
    _public_methods_ = ["GetSourceLineText",
                        "GetSourcePosition", "GetExceptionInfo"]
...
#	traceback.print_exc()
    ...
    gateway = win32com.server.util.wrap(
        instance, axscript.IID_IActiveScriptError)
    if debugManager:
    ...
    if result == winerror.S_OK:
        ...
        ret = win32com.server.exception.COMException(
            scode=axscript.SCRIPT_E_REPORTED)
        return ret
    else:
