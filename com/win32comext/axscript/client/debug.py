    ...
    def __init__(self, scriptEngine):
        ...
        if self.debugApplication is None:
            ...
            pdm = pythoncom.CoCreateInstance(
                axdebug.CLSID_ProcessDebugManager, None, pythoncom.CLSCTX_ALL, axdebug.IID_IProcessDebugManager)
        ...
        self.codeContainers = {}
        self.activeScriptDebug = _wrap(ActiveScriptDebug(
            self, self.codeContainers), axdebug.IID_IActiveScriptDebug)
...
class DebugCodeBlockContainer(SourceCodeContainer):
    def __init__(self, codeBlock, site):
        ...
        SourceCodeContainer.__init__(self, codeBlock.codeText, codeBlock.GetFileName(
        ), codeBlock.sourceContextCookie, codeBlock.startLineNumber, site)
...
class ActiveScriptDebug:
    ...
    """
    _public_methods_ = ["GetScriptTextAttributes",
                        "GetScriptletTextAttributes", "EnumCodeContextsOfPosition"]
    ...
    def EnumCodeContextsOfPosition(self, context, charOffset, numChars):
        ...
        try:
            context = self.codeContainers[context].GetCodeContextAtPosition(
                charOffset)
        except KeyError:
