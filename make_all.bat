...
py -3.6-32 setup.py -q bdist_wininst --skip-build
py -3.6-32 setup.py -q bdist_wheel --skip-build
py -3.6 setup.py -q bdist_wininst --skip-build
py -3.6 setup.py -q bdist_wheel --skip-build

py -3.7-32 setup.py -q bdist_wininst --skip-build
py -3.7-32 setup.py -q bdist_wheel --skip-build
py -3.7 setup.py -q bdist_wininst --skip-build
py -3.7 setup.py -q bdist_wheel --skip-build

py -3.8-32 setup.py -q bdist_wininst --skip-build
py -3.8-32 setup.py -q bdist_wheel --skip-build
py -3.8 setup.py -q bdist_wininst --skip-build
py -3.8 setup.py -q bdist_wheel --skip-build

py -3.9-32 setup.py -q bdist_wininst --skip-build
py -3.9-32 setup.py -q bdist_wheel --skip-build
py -3.9 setup.py -q bdist_wininst --skip-build
