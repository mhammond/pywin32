...
def main():
    ...
    try:
        if not opts.print_tree and not opts.transformed_tree: 
            compiler.save()
        compiler.finalize()
    except EnvironmentError, exc:
...
if __name__=='__main__':
    # The the environment for .NET private assembly
    import os
    os.environ["DEVPATH"] = os.path.abspath(os.path.split(sys.argv[0])[0])
    rc = main()
    ...
    from py2il import genil, funcsigs
    import pythoncom
